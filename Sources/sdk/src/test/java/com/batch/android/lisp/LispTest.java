...
public class LispTest
{
    ...
    private void assertBoolean(String expression, boolean expectedResult)
    {
        ...
        if (result instanceof ErrorValue) {
            ...
            if (error.type == ErrorValue.Type.Parser) {
                fail("Expression should be " + expectedResult + ", but could not be parsed: " + expression + "Error: " + error);
                return;
            }
            ...
            if (value.value instanceof Boolean) {
                ...
                assertEquals("Expression result should be " + expectedResult + ": " + expression,
                        expectedResult,
                        boolValue);
            ...
            fail("Expression result is of type bool, but the actual value could not be extracted. Looks like an internal error");
        } else {
            fail("Expression should be " + expectedResult + ", but executing it resulted in an unexpected value: " + expression);
        }
    }
    ...
    private void assertExpression(String expression, Value expectedAST)
    {
        ...
        assertEquals("Expression " + expression + " does not parse to expected AST: " + expectedAST,
                expectedAST,
                parsedExpression);
    }
