...
public class FindMyInstallationHelperTest extends DITest {
  ...
  @Test
  public void testInstallationIdInClipboard()
    ...
    Field fieldTimestamps =
      FindMyInstallationHelper.class.getDeclaredField("timestamps");
    ...
    Assert.assertEquals(
      ...
      clipboard.getPrimaryClip().getDescription().getLabel()
    );
    Assert.assertEquals(
  ...
  @Test
  public void testInstallationIdNotInClipboard()
    throws NoSuchFieldException, IllegalAccessException {
    helper = new FindMyInstallationHelper();
    Field fieldTimestamps =
      FindMyInstallationHelper.class.getDeclaredField("timestamps");
  ...
  @Test
  public void testSetFindMyInstallationEnabled()
    throws NoSuchFieldException, IllegalAccessException {
    helper = new FindMyInstallationHelper();
    Field fieldTimestamps =
      FindMyInstallationHelper.class.getDeclaredField("timestamps");
