...
public class DITestUtils {
   ...
   * @return
   */
  public static <T> T mockSingletonDependency(
    Class<T> clazz,
    Class<?>[] paramsType,
    Object... params
  ) {
    try {
      ...
      Class providerClass = Class.forName(
        "com.batch.android.di.providers." + clazz.getSimpleName() + "Provider"
      );
      Method getMethod;
      if (params.length > 0) {
      ...
      throw new RuntimeException(
        "Can't mock " + clazz.getName() + ": it's not annotated with @Module: "
      );
    }
  }
}
