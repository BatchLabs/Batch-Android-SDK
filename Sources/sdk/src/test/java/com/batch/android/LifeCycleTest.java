...
public class LifeCycleTest extends DITest
{
    ...
    public void testSessionID() throws Exception
    {
        ...
        RuntimeManagerProvider.get().registerSessionManagerIfNeeded(ApplicationProvider.getApplicationContext(),
                true);
        ...
        LocalBroadcastManager.getInstance(activity).sendBroadcast(new Intent(MessagingModule.ACTION_DISMISS_INTERSTITIAL));
        Thread.sleep(2000);
