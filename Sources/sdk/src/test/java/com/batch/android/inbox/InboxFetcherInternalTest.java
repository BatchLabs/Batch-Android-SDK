...
public class InboxFetcherInternalTest
{
    ...
    {
        PowerMockito.whenNew(InboxFetchWebserviceClient.class).withAnyArguments().then(new Answer<Object>()
        {
            @Override
            public Object answer(InvocationOnMock invocation) throws Throwable
            {
                ...
                PowerMockito.doReturn(new JSONObject(payload)).when(spy,
        ...
        InboxFetcherInternal fetcher = InboxFetcherInternalProvider.get(
                appContext,
                "test-install-id");
        ...
        Assert.assertNotEquals(notification.getNotificationIdentifier(),
