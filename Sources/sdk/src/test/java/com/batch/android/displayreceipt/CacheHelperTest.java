...
public class CacheHelperTest
{
    ...
    public CacheHelperTest()
    {
        ...
        testData = ( "Lorem ipsum dolor sit amet," +
                ...
                "ut labore et dolore magna aliqua." ).getBytes(java.nio.charset.StandardCharsets.UTF_8);
    }
    ...
    public void testReadFilesMax() throws IOException
    {
        ...
        File testReceipt1 = new File(testCache,
                filename1 + "-1af0f7ca-534e-43d6-873d-81bcae798061.bin");
        File testReceipt2 = new File(testCache,
                filename2 + "-1af0f7ca-534e-43d6-873d-81bcae798061.bin");
        File testReceipt3 = new File(testCache,
                filename3 + "-1af0f7ca-534e-43d6-873d-81bcae798061.bin");
        File testReceipt4 = new File(testCache,
                filename4 + "-1af0f7ca-534e-43d6-873d-81bcae798061.bin");
        File testReceipt5 = new File(testCache,
                filename5 + "-1af0f7ca-534e-43d6-873d-81bcae798061.bin");
        File testReceipt6 = new File(testCache,
                filename6 + "-1af0f7ca-534e-43d6-873d-81bcae798061.bin");
    ...
    public void testReadFilesOrder() throws IOException
    {
        ...
        File testReceipt1 = new File(testCache,
                filename2 + "-1af0f7ca-534e-43d6-873d-81bcae798061.bin");
        File testReceipt2 = new File(testCache,
                filename4 + "-d095a149-d15e-459d-a4a0-f999ebd71993.bin");
        File testReceipt3 = new File(testCache,
                "null-fb73fea5-1b33-4475-ae69-07fc12021d03.bin"); // Null
        File testReceipt4 = new File(testCache,
                filename3 + "-1af0f7ca-534e-43d6-873d-81bcae798061");
        File testReceipt5 = new File(testCache,
                "a69509aef65540-88756088-b13f-4f27-9da6-3c3e8116caa5"); // Invalid
        File testReceipt6 = new File(testCache,
                "-987-88756088-b13f-4f27-9da6-3c3e8116caa5"); // Negative
        File testReceipt7 = new File(testCache,
                "654654654654654654654654654-88756088-b13f-4f27-9da6-3c3e8116caa5"); // Overflow
        File testReceipt8 = new File(testCache,
                filename1 + "-1af0f7ca-534e-43d6-873d-81bcae798061");
        ...
        // Check ordering
        assertEquals(filename1 + "-1af0f7ca-534e-43d6-873d-81bcae798061",
                receipts.get(0).getName());
        assertEquals(filename2 + "-1af0f7ca-534e-43d6-873d-81bcae798061.bin",
                receipts.get(1).getName());
        assertEquals(filename3 + "-1af0f7ca-534e-43d6-873d-81bcae798061",
                receipts.get(2).getName());
        assertEquals(filename4 + "-d095a149-d15e-459d-a4a0-f999ebd71993.bin",
                receipts.get(3).getName());
