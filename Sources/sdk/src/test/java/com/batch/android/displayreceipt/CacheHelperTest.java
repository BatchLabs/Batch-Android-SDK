...
public class CacheHelperTest {
  ...
  public void testReadFilesOrder() throws IOException {
    ...
    File testReceipt3 = new File(
      testCache,
      "null-fb73fea5-1b33-4475-ae69-07fc12021d03.bin"
    ); // Null
    File testReceipt4 = new File(
      testCache,
    ...
    File testReceipt5 = new File(
      testCache,
      "a69509aef65540-88756088-b13f-4f27-9da6-3c3e8116caa5"
    ); // Invalid
    File testReceipt6 = new File(
      testCache,
      "-987-88756088-b13f-4f27-9da6-3c3e8116caa5"
    ); // Negative
    File testReceipt7 = new File(
      testCache,
      "654654654654654654654654654-88756088-b13f-4f27-9da6-3c3e8116caa5"
    ); // Overflow
    File testReceipt8 = new File(
      testCache,
