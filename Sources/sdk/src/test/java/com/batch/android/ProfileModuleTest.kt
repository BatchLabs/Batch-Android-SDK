...
class ProfileModuleTest : DITest() {
    ...
    fun testIdentifyWithNullID() {
        ...
        Mockito.verify(trackerModule, Mockito.timeout(1500).times(1))
                .track(ArgumentMatchers.eq(InternalEvents.PROFILE_IDENTIFY), JSONObjectMockitoMatcher.eq(expectedParams))
    ...
    fun testIdentifyWithInvalidID() {
        ...
        val customID = "my_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_idmy_test_id_1111"
    ...
    fun testTrackPublicEvent() {
        ...
        Mockito.verify(trackerModule, Mockito.times(1)).track(ArgumentMatchers.eq("E.TEST_EVENT"), JSONObjectPartialMatcher.eq(EventAttributesSerializer.serialize(eventData)))
    }
    ...
    fun testOnProjectChanged() {
        ...
        val atcResponse = AttributesCheckResponse("test_query_id").apply {
            setActionString("OK")
    ...
    fun testOnProjectDidNotChanged() {
        ...
        val atsResponse = AttributesSendResponse("test_query_id").apply {
    ...
    fun testCustomDataMigration() {
        ...
        Mockito.verify(trackerModule, Mockito.timeout(100).times(1))
                .track(ArgumentMatchers.eq(InternalEvents.PROFILE_DATA_CHANGED), JSONObjectPartialMatcher.eq(expectedParams))
    }
