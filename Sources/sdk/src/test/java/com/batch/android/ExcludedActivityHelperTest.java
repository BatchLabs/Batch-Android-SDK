...
public class ExcludedActivityHelperTest
{
    ...
    @Rule
    public ActivityTestRule<TestActivity> mainActivityRule = new ActivityTestRule<>(TestActivity.class,
            false,
            true);
    ...
    public void testActivityIsExcluded()
    {
        ...
        boolean shouldIgnore = ExcludedActivityHelper.activityIsExcludedFromManifest(
                excludedActivity);
    ...
    public void testSessionManager() throws IllegalAccessException
    {
        ...
        runtimeManager.registerSessionManagerIfNeeded(ApplicationProvider.getApplicationContext(),
                true);
