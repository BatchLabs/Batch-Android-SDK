...
{
    private String payloadJson = "{\"t\":\"c\",\"l\":\"https://batch.com\",\"i\":\"79946434-e5c3-4b22-1a1a-68e8f556740a\",\"od\":{\"n\":\"02521fa3e-70e4-11ea-b5ac-bf057dd56464\",\"ct\":\"2918f6a1d46ff48c9e74bfded5d5d9c9e\"}}";
...
// -------------------------------------------------->
    ...
    public void testInsertFetcherIds()
    {
        ...
        assertEquals(1,
                cursor.getInt(cursor.getColumnIndex(InboxDatabaseHelper.COLUMN_FETCHER_TYPE)));
        assertEquals("test-custom-id",
                cursor.getString(cursor.getColumnIndex(InboxDatabaseHelper.COLUMN_FETCHER_IDENTIFIER)));

        long fetcherId2 = datasource.getFetcherID(FetcherType.INSTALLATION,
        ...
        assertEquals(0,
                cursor2.getInt(cursor2.getColumnIndex(InboxDatabaseHelper.COLUMN_FETCHER_TYPE)));
    ...
    public void testGetNotifications()
    {
        ...
        NotificationIdentifiers identifiers2 = new NotificationIdentifiers("test-id-2",
                "test-send-id-2");
        identifiers.installID = "b5baf3e0-a01f-11ea-111a-17c13e111be2-2";
        InboxNotificationContentInternal
                notification2 = new InboxNotificationContentInternal(
        ...
        List<InboxNotificationContentInternal> notifications = datasource.getNotifications(Arrays.asList(
                "test-id",
                "test-id-2"), fetcherId);
    ...
    public void testUpdate() throws JSONException
    {
        ...
        assertEquals(0,
                cursor.getInt(cursor.getColumnIndex(InboxDatabaseHelper.COLUMN_UNREAD)));
        assertEquals(123456000,
                cursor.getLong(cursor.getColumnIndex(InboxDatabaseHelper.COLUMN_DATE)));
        assertEquals("test-id",
                cursor.getString(cursor.getColumnIndex(InboxDatabaseHelper.COLUMN_NOTIFICATION_ID)));
        assertEquals("updated-send-id",
                cursor.getString(cursor.getColumnIndex(InboxDatabaseHelper.COLUMN_SEND_ID)));
        ...
        assertEquals("test-id",
                cursor2.getString(cursor2.getColumnIndex(InboxDatabaseHelper.COLUMN_NOTIFICATION_ID)));
        assertEquals("updated-install-id",
                cursor2.getString(cursor2.getColumnIndex(InboxDatabaseHelper.COLUMN_INSTALL_ID)));
    ...
    {
        long fetcherIdInstall = datasource.getFetcherID(FetcherType.INSTALLATION,
                "test-install-id");
    ...
    public void testGetCandidate()
    {
        ...
        candidates = datasource.getCandidateNotifications(
                "test-id-1",
                2,
                fetcherId);
    ...
    {
        long fetcherIdCustom = datasource.getFetcherID(FetcherType.USER_IDENTIFIER,
                "test-custom-id");
