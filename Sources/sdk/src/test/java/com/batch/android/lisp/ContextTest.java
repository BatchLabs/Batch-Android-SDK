...
public class ContextTest {
    ...
    public void testPrivateEventContext() {
        ...
        assertEquals(PrimitiveValue.nilValue(), resolveSimple(context, "e.attr['foo']"));
    ...
    public void testPublicEventContext() {
        ...
        assertEquals(new PrimitiveValue(true), resolveLowercased(context, "e.attr['bool']"));
        assertEquals(new PrimitiveValue(2.0), resolveLowercased(context, "e.attr['double']"));
        assertEquals(new PrimitiveValue(2.0), resolveLowercased(context, "e.attr['float']"));
        assertEquals(new PrimitiveValue(2.0), resolveLowercased(context, "e.attr['int']"));
        assertEquals(new PrimitiveValue("str"), resolveLowercased(context, "e.attr['string']"));
        assertEquals(PrimitiveValue.nilValue(), resolveLowercased(context, "e.attr['missing']"));

        assertEquals(new PrimitiveValue("str"), resolveLowercased(context, "e.attr['STRING']"));
        assertEquals(new PrimitiveValue("str"), resolveLowercased(context, "e.attr['caps']"));
    ...
    public void testNativeAttributeContext() {
        ...
        assertEquals(new PrimitiveValue(String.valueOf(API_LEVEL)), resolveLowercased(context, "b.lvl"));
...
class MockDataSource implements UserDatasource {
    ...
    MockDataSource(HashMap<String, UserAttribute> attributes, Map<String, Set<String>> tagCollections) {
