...
public class ContextTest {
  ...
  public void testMetaContext() {
    ...
    evalContexts.add(
      new SimpleVariableContext("foo", new PrimitiveValue("bar"))
    );
    evalContexts.add(
      new SimpleVariableContext("lorem", new PrimitiveValue("ipsum"))
    );
    ...
    assertEquals(
      ...
      context.resolveVariableNamed("foo")
    );
    assertEquals(
      new PrimitiveValue("ipsum"),
      context.resolveVariableNamed("lorem")
    );
  ...
  public void testCachingContext() {
    AlternatingContext alternatingContext = new AlternatingContext(
      new PrimitiveValue("foo")
    );

    CachingContext cachingContext = new CachingContext(alternatingContext);
    assertEquals(
      new PrimitiveValue("foo"),
      cachingContext.resolveVariableNamed("foo")
    );
  ...
  public void testPrivateEventContext() {
    ...
    assertEquals(
      new PrimitiveValue("_START"),
      resolveSimple(context, "e.name")
    );
  ...
  public void testPublicEventContext() {
    ...
    assertEquals(
      new PrimitiveValue("E.TEST_EVENT"),
      resolveLowercased(context, "e.name")
    );
    assertEquals(
      new PrimitiveValue("test label"),
      resolveLowercased(context, "e.label")
    );
    assertEquals(
      new PrimitiveValue(new HashSet<>(Arrays.asList("foo", "bar"))),
  ...
  public void testNativeAttributeContext() {
    NativeAttributeContext context = new NativeAttributeContext(
      activityRule.getActivity()
    );

    assertEquals(
      new PrimitiveValue(String.valueOf(API_LEVEL)),
      resolveLowercased(context, "b.lvl")
    );
    assertEquals(
      PrimitiveValue.nilValue(),
      resolveLowercased(context, "b.foobar")
    );
  ...
  public void testUserAttributeContext() {
    ...
    tagCollections.put(
      "collection1",
      new HashSet<>(Arrays.asList("foo", "bar", "foo"))
    );
    ...
    attributes.put(
      "c.double",
      new UserAttribute(234.567, AttributeType.DOUBLE)
    );
    attributes.put("c.bool", new UserAttribute(true, AttributeType.BOOL));
    attributes.put(
      "c.date",
      new UserAttribute(new Date(1536325808234L), AttributeType.DATE)
    );
    attributes.put(
      "c.null",
      new UserAttribute(Null.NULL, AttributeType.DELETED)
    );
    attributes.put(
      "c.inconsistent",
      new UserAttribute(2, AttributeType.STRING)
    );
    ...
    assertEquals(
      PrimitiveValue.nilValue(),
      resolveLowercased(context, "c.missing")
    );
    assertEquals(
      new PrimitiveValue("string"),
      resolveLowercased(context, "c.str")
    );
    assertEquals(new PrimitiveValue(2), resolveLowercased(context, "c.long"));
    assertEquals(
      new PrimitiveValue(234.567),
      resolveLowercased(context, "c.double")
    );
    assertEquals(
      new PrimitiveValue(true),
      resolveLowercased(context, "c.bool")
    );
    assertEquals(
      new PrimitiveValue(1536325808234.),
      resolveLowercased(context, "c.date")
    );
    assertEquals(
      PrimitiveValue.nilValue(),
      resolveLowercased(context, "c.null")
    );
    assertEquals(
      PrimitiveValue.nilValue(),
      resolveLowercased(context, "c.inconsistent")
    );

    assertEquals(
      PrimitiveValue.nilValue(),
      resolveLowercased(context, "t.missing")
    );
    assertEquals(
      new PrimitiveValue(new HashSet<>(Arrays.asList("foo", "bar"))),
...
class MockDataSource implements UserDatasource {
  ...
  MockDataSource(
    HashMap<String, UserAttribute> attributes,
  ...
  @Override
  public void acquireTransactionLock(long changeset)
  ...
  @Override
  public void setAttribute(@NonNull String key, long attribute)
    throws UserDatabaseException {}

  @Override
  public void setAttribute(@NonNull String key, double attribute)
    throws UserDatabaseException {}

  @Override
  public void setAttribute(@NonNull String key, boolean attribute)
    throws UserDatabaseException {}

  @Override
  public void setAttribute(@NonNull String key, @NonNull String attribute)
    throws UserDatabaseException {}

  @Override
  public void setAttribute(@NonNull String key, @NonNull Date attribute)
    throws UserDatabaseException {}

  @Override
  public void setAttribute(@NonNull String key, @NonNull URI attribute)
    throws UserDatabaseException {}
  ...
  @Override
  public void addTag(@NonNull String collection, @NonNull String tag)
    throws UserDatabaseException {}

  @Override
  public void removeTag(@NonNull String collection, @NonNull String tag)
    throws UserDatabaseException {}
