...
public class CampaignManagerTest
{
    ...
    public void setUp() throws IOException, JSONException
    {
        ...
        jsonCampaigns = new JSONObject(jsonCampaignsStringBuilder.toString()).getJSONArray("queries").getJSONObject(
                0);
    }
    ...
    {
        Field inappCampaignsFileNameField = CampaignManager.class.getDeclaredField(
