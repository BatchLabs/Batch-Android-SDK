...
public class CampaignManagerTest {
  ...
  public void setUp() throws IOException, JSONException {
    ...
    jsonCampaigns =
      new JSONObject(jsonCampaignsStringBuilder.toString())
  ...
  public void testSaveCampaigns()
    ...
    LocalCampaignsResponse response = new LocalCampaignsResponseDeserializer(
      jsonCampaigns
    )
      .deserialize();
   ...
   */
  @Test
  public void testSaveAndLoadCampaigns()
    throws NoSuchFieldException, IllegalAccessException, JSONException {
  ...
  public void testGracePeriod()
    ...
    Field dateProviderField =
      CampaignManager.class.getDeclaredField("dateProvider");
    dateProviderField.setAccessible(true);
    dateProviderField.set(
      campaignManager,
      (DateProvider) () -> fakeCurrentDate
    );
  ...
  public void testPriority()
    ...
    LocalCampaign campainToDisplay = campaignManager.getCampaignToDisplay(trigger ->
      true
    );
  ...
  private void removeExistingSave()
    ...
    Field inappCampaignsFileNameField =
      CampaignManager.class.getDeclaredField(
          "PERSISTENCE_LOCAL_CAMPAIGNS_FILE_NAME"
        );
    inappCampaignsFileNameField.setAccessible(true);
    final String INAPP_CAMPAIGNS_FILE_NAME = (String) inappCampaignsFileNameField.get(
      null
    );
