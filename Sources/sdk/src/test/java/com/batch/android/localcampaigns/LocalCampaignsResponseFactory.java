...
public class LocalCampaignsResponseFactory {
  ...
  public LocalCampaignsResponse createLocalCampaignsResponse()
  ...
  public JSONObject createValidJsonResponse()
    ...
    return new JSONObject(jsonCampaignsStringBuilder.toString())
