...
public class PayloadParserTest
{
    ...
    {
        String payload = "{'image':'https://static.batch.com/tmp/test_inapp.jpg','hasImage':true,'kind':'image','id':'tmpid','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'batch.deeplink','args':{'l':'https://google.fr'}},'style':'@import sdk(\\\"image1-detached\\\");'}";
    ...
    {
        String payload = "{'hasImage':true,'kind':'image','id':'webtest','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'batch.deeplink','args':{'l':'https://google.fr'}},'style':'@import sdk(\\\"image1-detached\\\");'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'image':'https://static.batch.com/tmp/test_inapp.jpg','hasImage':true,'kind':'image','id':'webtest','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'batch.deeplink','args':{'l':'https://google.fr'}}}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'image':'https://static.batch.com/tmp/test_inapp.jpg','hasImage':true,'kind':'image','id':'webtest','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'batch.deeplink','args':{'l':'https://google.fr'}},'style':'wrong-cs;s;sd'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'image':'https://static.batch.com/tmp/test_inapp.jpg','width':-1,'height':-1,'hasImage':true,'kind':'image','id':'webtest','did':'webtest','fullscreen': false,'auto_close': 0,'action': {'a': 'batch.deeplink','args':{'l':'https://google.fr'}},'style':'@import sdk(\\\"image1-detached\\\");'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'url':'https://batch-html-inapp-test.glitch.me/index.html','kind':'webview','id':'tmpid','did':'webtest','style':'@import sdk(\\\"webview1\\\");'}";
        JSONObject json = new JSONObject(payload);

        Message message = PayloadParser.parsePayload(json);
        Assert.assertTrue(message instanceof WebViewMessage);
        WebViewMessage webViewMessage = (WebViewMessage) message;
        Assert.assertEquals("https://batch-html-inapp-test.glitch.me/index.html",
                webViewMessage.url);
    ...
    {
        String payload = "{'url':'file://je/suis/un/test.html','kind':'webview','id':'tmpid','did':'webtest','style':'@import sdk(\\\"webview1\\\");'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'url':'testswag22','kind':'webview','id':'tmpid','did':'webtest','style':'@import sdk(\\\"webview1\\\");'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'url':'https://batch-html-inapp-test.glitch.me/index.html','kind':'webview','id':'tmpid','did':'webtest'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'url':'https://batch-html-inapp-test.glitch.me/index.html','kind':'webview','id':'tmpid','did':'webtest', 'style':'pdigr;sefs'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'cta':[{'l':'testLabel', 'a': 'batch.deeplink','args':{'l':'https://google.fr'}}],'ctaCount':1,'hasImage':true,'id':'tmpid','did':'webtest','image':'https://test.com/image.jpg','action': {'a': 'batch.deeplink','args':{'l':'https://google.fr'}},'kind':'modal','close':true,'cta_direction':'h','auto_close':0,'style':'@import sdk(\\\"modal1\\\");'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'cta':[{'l':'testLabel', 'a': 'batch.deeplink','args':{'l':'https://google.fr'}}],'ctaCount':1,'hasImage':true,'id':'tmpid','did':'webtest','image':'https://test.com/image.jpg','action': {'a': 'batch.deeplink','args':{'l':'https://google.fr'}},'kind':'modal','close':true,'cta_direction':'h','auto_close':0}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'cta':[{'l':'testLabel', 'a': 'batch.deeplink','args':{'l':'https://google.fr'}}],'ctaCount':1,'hasImage':true,'id':'tmpid','did':'webtest','image':'https://test.com/image.jpg','action': {'a': 'batch.deeplink','args':{'l':'https://google.fr'}},'kind':'modal','close':true,'cta_direction':'h','auto_close':0, 'style':'sefs;sef;s'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        String payload = "{'cta':[{'l':'testLabel', 'a': 'batch.deeplink','args':{'l':'https://google.fr'}}],'ctaCount':1,'hasImage':true,'id':'tmpid','did':'webtest','image':'https://test.com/image.jpg','action': {'a': 'batch.deeplink','args':{'l':'https://google.fr'}},'kind':'banner','close':true,'cta_direction':'h','auto_close':0,'style':'@import sdk(\\\"banner1\\\");'}";
        JSONObject json = new JSONObject(payload);
    ...
    public void testUniversalPayload() throws PayloadParsingException, JSONException
    {
        ...
        String payload = "{'cta':[{'l':'testLabel', 'a': 'batch.deeplink','args':{'l':'https://google.fr'}}],'id':'tmpid','did':'webtest','ctaCount':1,'hasImage':false,'kind':'universal','flip_hero_h':false,'flip_hero_v':true,'attach_cta_bottom':true,'stack_cta_h':false,'stretch_cta_h':true,'hero_split_ratio':0.4,'close':false,'style':'@import sdk(\\\"generic1-v-cta\\\");'}";
        JSONObject json = new JSONObject(payload);
    ...
    {
        // Recent enough
        String payload = "{'min_android_sdk': 26, 'url':'https://batch-html-inapp-test.glitch.me/index.html','kind':'webview','id':'tmpid','did':'webtest','style':'@import sdk(\\\"webview1\\\");'}";
        JSONObject json = new JSONObject(payload);
