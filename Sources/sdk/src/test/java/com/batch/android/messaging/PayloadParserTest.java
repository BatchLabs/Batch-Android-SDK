...
public class PayloadParserTest {
  ...
  public void testImagePayload() throws PayloadParsingException, JSONException {
    ...
    Assert.assertEquals(
      "https://static.batch.com/tmp/test_inapp.jpg",
  ...
  @Test
  public void testWebViewPayload()
    ...
    Assert.assertEquals(
      "https://batch-html-inapp-test.glitch.me/index.html",
      webViewMessage.url
    );
  ...
  public void testWebViewNoUrlPayload() throws JSONException {
    String payload =
      "{'kind':'webview','id':'tmpid','did':'webtest','style':'@import sdk(\\\"webview1\\\");'}";
    JSONObject json = new JSONObject(payload);
  ...
  public void testModalPayload() throws PayloadParsingException, JSONException {
    ...
    Assert.assertEquals(
      BaseBannerMessage.CTADirection.HORIZONTAL,
      modalMessage.ctaDirection
    );
  ...
  @Test
  public void testUniversalPayload()
    throws PayloadParsingException, JSONException {
    String payload =
  ...
  @Test
  @Config(sdk = { O })
  public void testMinimumAndroidVersion()
    throws PayloadParsingException, JSONException {
    // Recent enough
    String payload =
