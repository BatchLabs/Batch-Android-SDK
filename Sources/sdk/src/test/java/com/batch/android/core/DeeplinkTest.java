...
public class DeeplinkTest {
  ...
  public void testCustomTabSchemes() {
    assertTrue(
      DeeplinkHelper.customTabSupportsURI(Uri.parse("https://batch.com"))
    );
    assertTrue(
      DeeplinkHelper.customTabSupportsURI(Uri.parse("HTTPS://batch.com"))
    );
    assertTrue(
      DeeplinkHelper.customTabSupportsURI(Uri.parse("http://batch.com"))
    );
    assertTrue(
      DeeplinkHelper.customTabSupportsURI(Uri.parse("HTTP://batch.com"))
    );
    ...
    assertFalse(
      DeeplinkHelper.customTabSupportsURI(Uri.parse("foobar://batch.com"))
    );
  }
  ...
  public void testCustomTabIntent() {
    ...
    assertTrue(
      Objects
        ...
        .containsKey("android.support.customtabs.extra.SESSION")
    );
  }
