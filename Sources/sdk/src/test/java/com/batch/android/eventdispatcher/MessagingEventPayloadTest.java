...
public class MessagingEventPayloadTest
{
    ...
    public void testValidData()
    {
        ...
        MessagingEventPayload eventPayload = new MessagingEventPayload(null,
                payload,
                customPayload);
        ...
        MessagingEventPayload eventPayloadCTA1 = new MessagingEventPayload(null,
                payload,
                null,
                cta1);

        Assert.assertTrue(eventPayloadCTA1.isPositiveAction());
        Assert.assertEquals(eventPayloadCTA1.getDeeplink(),
        ...
        MessagingEventPayload eventPayloadCTA2 = new MessagingEventPayload(null,
                payload,
                null,
                cta2);

        Assert.assertTrue(eventPayloadCTA2.isPositiveAction());
        Assert.assertEquals(eventPayloadCTA2.getDeeplink(),
        ...
        MessagingEventPayload eventPayloadCTA3 = new MessagingEventPayload(null,
                payload,
                null,
                cta3);
