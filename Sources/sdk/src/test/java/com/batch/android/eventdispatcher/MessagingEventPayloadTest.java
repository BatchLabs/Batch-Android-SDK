...
public class MessagingEventPayloadTest {
  ...
  public void testValidData() {
    ...
    MessagingEventPayload eventPayload = new MessagingEventPayload(
      null,
      payload,
      customPayload
    );
    ...
    MessagingEventPayload eventPayloadCTA1 = new MessagingEventPayload(
      null,
      payload,
      null,
      cta1
    ...
    MessagingEventPayload eventPayloadCTA2 = new MessagingEventPayload(
      null,
      payload,
      null,
      cta2
    ...
    MessagingEventPayload eventPayloadCTA3 = new MessagingEventPayload(
      null,
      payload,
      null,
      cta3
