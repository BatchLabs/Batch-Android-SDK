...
public class BatchEventData {
  ...
  public BatchEventData addTag(String tag) {
    if (tags.size() >= MAXIMUM_TAGS) {
      Logger.internal(
        TrackerModule.TAG,
        "BatchEventData: Event data cannot hold more than 10 tags. Ignoring: '" +
        tag +
        "'"
      );
      return this;
  ...
  public BatchEventData put(String key, String value) {
    if (
      enforceAttributesCount(key) &&
      enforceAttributeName(key) &&
      enforceStringValue(value)
    ) {
      attributes.put(
        normalizeKey(key),
        new TypedAttribute(value, AttributeType.STRING)
      );
      return this;
    }
    return this;
  ...
  public BatchEventData put(String key, URI value) {
    if (
      enforceAttributesCount(key) &&
      enforceAttributeName(key) &&
      enforceURIValue(value)
    ) {
      attributes.put(
        normalizeKey(key),
        new TypedAttribute(value, AttributeType.URL)
      );
      return this;
    }
    return this;
  ...
  public BatchEventData put(String key, float value) {
    if (enforceAttributeName(key) && enforceAttributesCount(key)) {
      attributes.put(
        normalizeKey(key),
        new TypedAttribute(value, AttributeType.DOUBLE)
      );
      return this;
    }
    return this;
  ...
  public BatchEventData put(String key, int value) {
    if (enforceAttributeName(key) && enforceAttributesCount(key)) {
      attributes.put(
        normalizeKey(key),
        new TypedAttribute(value, AttributeType.LONG)
      );
      return this;
    }
    return this;
  ...
  public BatchEventData put(String key, boolean value) {
    if (enforceAttributeName(key) && enforceAttributesCount(key)) {
      attributes.put(
        normalizeKey(key),
        new TypedAttribute(value, AttributeType.BOOL)
      );
      return this;
    }
    return this;
  ...
  public BatchEventData put(String key, Date value) {
    if (
      enforceAttributeName(key) &&
      enforceAttributesCount(key) &&
      enforceDateValue(value)
    ) {
      attributes.put(
        normalizeKey(key),
        new TypedAttribute(value.getTime(), AttributeType.DATE)
      );
      return this;
    }
    return this;
  ...
  private boolean enforceAttributesCount(String key) {
    if (attributes.size() == MAXIMUM_VALUES && !attributes.containsKey(key)) {
      Logger.internal(
        TrackerModule.TAG,
        "BatchEventData: Event data cannot hold more than 15 attributes. Ignoring attribute: '" +
        key +
        "'"
      );
      return false;
  ...
  private boolean enforceURIValue(URI value) {
    ...
    if (value.toString().length() > MAXIMUM_URL_LENGTH) {
      Logger.internal(
        TrackerModule.TAG,
        "BatchEventData: URL attributes can't be longer than " +
        MAXIMUM_URL_LENGTH +
        " characters. Ignoring."
      );
      return false;
  ...
  private boolean enforceDateValue(Date value) {
    if (value == null) {
      Logger.internal(
        TrackerModule.TAG,
        "BatchEventData: Cannot add a null date attribute/tag. Ignoring."
      );
      return false;
    }
  ...
  private boolean enforceAttributeName(String key) {
    if (
      ...
      !BatchUserDataEditor.ATTR_KEY_PATTERN.matcher(key).matches()
    ) {
      Logger.internal(
        TrackerModule.TAG,
