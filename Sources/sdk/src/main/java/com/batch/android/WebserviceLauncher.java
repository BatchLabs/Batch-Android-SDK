...
public final class WebserviceLauncher
{
     ...
     */
    public static boolean launchStartWebservice(RuntimeManager runtimeManager,
                                                boolean fromPush,
                                                String pushId,
                                                boolean userActivity)
    {
        try {
            TaskExecutorProvider.get(
                    runtimeManager.getContext()).submit(new StartWebservice(
     ...
     */
    public static TaskRunnable initTrackerWebservice(RuntimeManager runtimeManager,
                                                     List<Event> events,
                                                     TrackerWebserviceListener listener)
    {
        try {
            return new TrackerWebservice(runtimeManager.getContext(),
                    listener,
                    events,
                    false);
        } catch (Exception e) {
     ...
     */
    public static TaskRunnable initDisplayReceiptWebservice(Context context,
                                                            DisplayReceiptPostDataProvider dataProvider,
                                                            DisplayReceiptWebserviceListener listener)
    {
        try {
            return new DisplayReceiptWebservice(context,
                    listener,
                    dataProvider);
        } catch (Exception e) {
     ...
     * @return instance of tracker webservice ready to be runned
     */
    public static TaskRunnable initOptOutTrackerWebservice(Context context,
                                                           List<Event> events,
                                                           TrackerWebserviceListener listener)
    {
        try {
            return new TrackerWebservice(context,
                    listener,
                    events,
                    true);
        } catch (Exception e) {
     ...
     */
    public static boolean launchPushWebservice(RuntimeManager runtimeManager,
                                               @NonNull Registration registration)
    {
        try {
            TaskExecutorProvider.get(
                    runtimeManager.getContext()).submit(new PushWebservice(
                    runtimeManager.getContext(),
                    registration,
                    new PushWebserviceListenerImpl()));
            return true;
        } catch (Exception e) {
    ...
    public static boolean launchAttributesSendWebservice(RuntimeManager runtimeManager,
                                                         long version,
                                                         ...
                                                         Map<String, Set<String>> tags)
    {
        try {
            TaskExecutorProvider.get(
                    runtimeManager.getContext()).submit(new AttributesSendWebservice(
                    runtimeManager.getContext(),
                    version,
                    attributes,
                    tags,
    ...
    public static boolean launchAttributesCheckWebservice(RuntimeManager runtimeManager,
                                                          long version,
                                                          String transactionID)
    {
        try {
            TaskExecutorProvider.get(
                    runtimeManager.getContext()).submit(new AttributesCheckWebservice(
                    runtimeManager.getContext(),
                    version,
                    transactionID,
    ...
    public static boolean launchLocalCampaignsWebservice(RuntimeManager runtimeManager)
    {
        try {
            TaskExecutorProvider.get(
                    runtimeManager.getContext()).submit(new LocalCampaignsWebservice(
                    runtimeManager.getContext(),
