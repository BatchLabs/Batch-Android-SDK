...
public class MessagingAnalyticsDelegate
{
    ...
    MessagingAnalyticsDelegate(MessagingModule messagingModule,
    ...
    public void onGlobalTap(@NonNull Action action)
    {
        ...
        eventDispatcherModule.dispatchEvent(type,
                new MessagingEventPayload(sourceMessage,
    ...
    public void onClosed()
    {
        ...
        eventDispatcherModule.dispatchEvent(Batch.EventDispatcher.Type.MESSAGING_CLOSE,
                new MessagingEventPayload(sourceMessage,
                        sourceMessage.getJSON(),
                        sourceMessage.getCustomPayloadInternal()));
    }
    ...
    public void onClosedError(@NonNull MessagingError cause)
    {
        ...
        eventDispatcherModule.dispatchEvent(Batch.EventDispatcher.Type.MESSAGING_CLOSE_ERROR,
                new MessagingEventPayload(sourceMessage,
                        sourceMessage.getJSON(),
                        sourceMessage.getCustomPayloadInternal()));
    }
    ...
    public void onAutoClosedAfterDelay()
    {
        ...
        eventDispatcherModule.dispatchEvent(Batch.EventDispatcher.Type.MESSAGING_AUTO_CLOSE,
                new MessagingEventPayload(sourceMessage,
                        sourceMessage.getJSON(),
                        sourceMessage.getCustomPayloadInternal()));
    }
    ...
    public void onViewShown()
    {
        ...
        if (sourceMessage instanceof BatchInAppMessage) {
            ...
            trackerModule.trackCampaignView(inAppMessage.getCampaignId(),
                    inAppMessage.getEventData());
        }

        eventDispatcherModule.dispatchEvent(Batch.EventDispatcher.Type.MESSAGING_SHOW,
                new MessagingEventPayload(sourceMessage,
                        sourceMessage.getJSON(),
                        sourceMessage.getCustomPayloadInternal()));
    }
