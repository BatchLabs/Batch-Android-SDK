...
public class LocalCampaignDeserializer {
   ...
   * @throws JSONException parsing exception
   */
  private LocalCampaign.Output parseOutput(JSONObject json)
   ...
   * @throws JSONException parsing exception
   */
  private List<LocalCampaign.Trigger> parseTriggers(JSONArray json)
    throws JSONException {
   ...
   * @throws JSONException parsing exception
   */
  private LocalCampaign.Trigger parseTrigger(JSONObject json)
    throws JSONException {
    String type = json.reallyOptString("type", null);
