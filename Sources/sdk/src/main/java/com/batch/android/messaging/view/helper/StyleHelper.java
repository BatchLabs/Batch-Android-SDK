...
public class StyleHelper
{
    ...
    public static void applyCommonRules(View targetView, Map<String, String> rules)
    {
            ...
            if ("background".equalsIgnoreCase(rule.getKey())) {
                ...
                if (value.startsWith("#")) {
                    try {
                        ...
                        Logger.internal(TAG,
                                "Unparsable background color (" + rule.getValue() + ")",
                                e);
                    }
                    ...
                    for (int i = 1; i < gradientArguments.length; i++) {
                        ...
                        // "%" will be stripped
                        String[] components = gradientArguments[i].replace("%", "").trim().split(
                                "\\s+",
                                2);
                    ...
                    backgroundGradient = new PositionableGradientDrawable(gradientOrientation,
                            colors,
                            positionsArray);
                }
                ...
                try {
                    ...
                    Logger.internal(TAG,
                            "Unparsable border-color (" + rule.getValue() + ")",
                            e);
                }
        ...
        if (!( targetView instanceof TextureView )) {
                    ...
                    borderWidth != null)
            {
                ...
                if (targetView instanceof AppCompatButton) {
                    ...
                    ViewCompat.setBackgroundTintList(targetView,
        ...
        targetView.setPadding(bgPadding.left + dpToPixels(res, padding[0]),
     ...
     */
    public static FlexboxLayout.LayoutParams getFlexLayoutParams(Context context,
                                                                 ...
                                                                 Map<String, String> rules)
    {
        ...
        if (baseParams != null) {
            ...
            lp = new FlexboxLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
        ...
        lp.setMargins(dpToPixels(res, margin[0]),
     ...
     * @return Layout parameters matching the CSS rules
     */
    public static PercentRelativeLayout.LayoutParams getRelativeLayoutParams(Context context,
                                                                             ...
                                                                             View relativeToView)
    {
        ...
        if (base != null) {
            ...
            lp = new PercentRelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        for (Map.Entry<String, String> rule : rules.entrySet()) {
            ...
            } else if ("align-v".equalsIgnoreCase(rule.getKey()) || "vertical-align".equalsIgnoreCase(
                    rule.getKey()))
            {
        ...
        lp.setMargins(StyleHelper.dpToPixels(res, margin[0]),
    ...
    private static Drawable getPressableGradientDrawable(PositionableGradientDrawable baseDrawable)
    {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            PositionableGradientDrawable mask = (PositionableGradientDrawable) baseDrawable.getConstantState().newDrawable().mutate();
            ...
            PositionableGradientDrawable darkDrawable = (PositionableGradientDrawable) baseDrawable.getConstantState().newDrawable().mutate();
