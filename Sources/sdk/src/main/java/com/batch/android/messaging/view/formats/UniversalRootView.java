...
public class UniversalRootView extends PercentRelativeLayout implements SeparatedFlexboxLayout.SeparatorStyleProvider
{
    ...
    public UniversalRootView(@NonNull Context context,
    ...
    private void setupContentLayout()
    {
        ...
        bodyTv.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        bodyScrollWrapper.setLayoutParams(StyleHelper.getFlexLayoutParams(context,
                bodyScrollWrapperLp,
                bodyTvRules));
    ...
    {
        PercentRelativeLayout.LayoutParams contentLP = StyleHelper.getRelativeLayoutParams(context,
                new PercentRelativeLayout.LayoutParams(
                        ViewGroup.LayoutParams.MATCH_PARENT,
                        ViewGroup.LayoutParams.MATCH_PARENT),
                contentStyleRules,
        ...
        if (ctasLayout != null) {
            ctasLP = StyleHelper.getRelativeLayoutParams(context,
                    new PercentRelativeLayout.LayoutParams(
                            ViewGroup.LayoutParams.MATCH_PARENT,
                            ViewGroup.LayoutParams.WRAP_CONTENT),
                    ctasStyleRules,
        ...
        if (heroLayout != null) {
            ...
            if (!landscape) {
                ...
                heroLP = new PercentRelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                        0);
                heroLP.getPercentLayoutInfo().heightPercent = message.heroSplitRatio != null ? message.heroSplitRatio.floatValue() : 0.4f;
                ...
                // Configure the split ratio for the right orientation
                heroLP = new PercentRelativeLayout.LayoutParams(0,
                        ViewGroup.LayoutParams.MATCH_PARENT);
                heroLP.getPercentLayoutInfo().widthPercent = message.heroSplitRatio != null ? message.heroSplitRatio.floatValue() : 0.4f;
