...
// ------------------------------------------->
     ...
     */
    protected StartWebservice(Context context,
                              boolean fromPush,
                              String pushId,
                              boolean userActivity,
                              StartWebserviceListener listener) throws MalformedURLException
    {
...
// ------------------------------------------->
    ...
    protected List<Query> getQueries()
    {
        ...
        if (registration != null) {
            queries.add(new PushQuery(applicationContext,
                    registration));
        }
    ...
    public void run()
    {
        try {
            ...
            try {
                ...
                Logger.internal(TAG, "Error on StartWebservice : " + error.getReason().toString(),
                        error.getCause());
