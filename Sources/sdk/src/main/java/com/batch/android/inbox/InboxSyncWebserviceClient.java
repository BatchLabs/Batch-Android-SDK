...
public class InboxSyncWebserviceClient extends BatchWebservice implements TaskRunnable
{
    ...
    public InboxSyncWebserviceClient(@NonNull Context context,
        ...
        try {
            ...
            if (cache != null) {
                ...
                if (cacheMarkAllAsRead > 0) {
                    InboxDatasourceProvider.get(applicationContext)
                            .markAllAsRead(cacheMarkAllAsRead, fetcherId);
                }
            ...
            for (int i = 0; i < rawNotifications.length(); i++) {
                ...
                if (rawNotification instanceof JSONObject) {
                    ...
                    String notificationId = ( (JSONObject) rawNotification ).reallyOptString(
                            "notificationId",
                            null);
                    ...
                    if (notificationId != null) {
                        if (isCandidates(notificationId)) {
                            ...
                            String id = InboxDatasourceProvider.get(applicationContext)
                            ...
                            try {
                                ...
                                if (InboxDatasourceProvider.get(applicationContext).insert(
                                        newNotification,
                                        fetcherId))
                                {
                        ...
                        Logger.internal(TAG,
                                "Json element doesn't have an id in notification array, skipping. Found: " + rawNotification.toString());
                    }
                } else {
                    Logger.internal(TAG,
            ...
            r.notifications = InboxDatasourceProvider.get(applicationContext).getNotifications(ids,
                    fetcherId);
            return r;
