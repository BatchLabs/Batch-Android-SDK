...
// ------------------------------------------>
    ...
    protected PushWebservice(Context context,
                             @NonNull Registration registration,
                             PushWebserviceListener listener) throws MalformedURLException
    {
    ...
    public void run()
    {
        try {
            ...
            try {
                ...
                Logger.internal(TAG, "Error on PushWebservice : " + error.getReason().toString(),
                        error.getCause());
