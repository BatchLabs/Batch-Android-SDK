...
public class WebFormatView extends FrameLayout
{
    ...
    public WebFormatView(@NonNull Context context,
                         ...
                         @NonNull BatchMessagingWebViewJavascriptBridge jsInterface)
    {
        ...
        webView.setWebViewClient(new WebViewClient()
        {
                                        ...
                                        String failingUrl)
            {
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP && !mainFrameFinished) {
                                           ...
                                           SslError error)
            {
                ...
                if (!mainFrameFinished) {
                    closeMessageWithError(DevelopmentErrorCause.SSL,
                                            ...
                                            WebResourceResponse errorResponse)
            {
                ...
                if (request.isForMainFrame()) {
                    closeMessageWithError(DevelopmentErrorCause.BAD_HTTP_STATUSCODE,
                            MessagingError.SERVER_FAILURE,
    ...
    private void handleWebViewError(String description, int errorCode)
    {
        ...
        closeMessageWithError(DevelopmentErrorCause.UNKNOWN,
                messagingCause,
                description);
    }
    ...
    private void closeMessageWithError(DevelopmentErrorCause developmentCause,
    ...
    {
        if (!timeoutDone) {
            closeMessageWithError(DevelopmentErrorCause.TIMEOUT,
    ...
    private AlertDialog.Builder makeAlertBuilder()
    {
        return new AlertDialog.Builder(new ContextThemeWrapper(context,
                ThemeHelper.getDefaultTheme(context)));
    }
    ...
    private RelativeLayout addRootContainerView()
    {
        ...
        rootContainer.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
