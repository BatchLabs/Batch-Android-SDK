...
public final class Parameters {
   ...
   */
  protected static final String COMMON_EXTERNAL_CRYPT_SIGNATURE_KEY =
    "QiExXW9PdC8="; //B!1]oOt/
  ...
  public static final boolean ENABLE_WS_INTERCEPTOR =
    BuildConfig.ENABLE_WS_INTERCEPTOR;
   ...
   */
  public static final String PLUGIN_VERSION_ENVIRONEMENT_VAR =
    "batch.plugin.version";
  /**
   * Environement var to get Batch bridge version (to put it into User-Agent)
   */
  public static final String BRIDGE_VERSION_ENVIRONEMENT_VAR =
    "batch.bridge.version";
  ...
  private static final String BASE_WS_URL =
    "https://" + BuildConfig.WS_DOMAIN + "/a/" + SDK_VERSION;
   ...
   */
  public static final String INBOX_FETCH_WS_URL =
    BASE_WS_URL + "/inbox/%s/%s/%s";
  /**
   * URL of the inbox sync WS
   */
  public static final String INBOX_SYNC_WS_URL =
    BASE_WS_URL + "/inbox/%s/sync/%s/%s";
  /**
   * URL of the display receipt WS
   */
  public static final String DISPLAY_RECEIPT_WS_URL =
    "https://dr" + BuildConfig.WS_DOMAIN + "/a/%s";
  ...
  public String get(String key) {
    ...
    String userValue = KVUserPreferencesStorageProvider
      .get(applicationContext)
      .get(PARAMETERS_KEY_PREFIX + key);
    if (userValue != null) {
      return userValue;
    }
  ...
  public void set(String key, String value, boolean save) {
    ...
    if (save) {
      KVUserPreferencesStorageProvider
        .get(applicationContext)
        .persist(PARAMETERS_KEY_PREFIX + key, value);
    }
  }
  ...
  public void remove(String key) {
    ...
    KVUserPreferencesStorageProvider
      .get(applicationContext)
      .remove(PARAMETERS_KEY_PREFIX + key);
  }
}
