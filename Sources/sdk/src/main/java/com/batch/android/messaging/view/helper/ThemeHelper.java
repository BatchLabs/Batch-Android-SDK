...
public class ThemeHelper {
  ...
  public static int getDefaultTheme(@NonNull Context context) {
    ...
    resolvedTheme =
      getThemeByName("Theme.AppCompat.DayNight", resources, packageName);
    if (resolvedTheme != 0) {
      return resolvedTheme;
    }
    resolvedTheme =
      getThemeByName("Theme.AppCompat.Light", resources, packageName);
    if (resolvedTheme != 0) {
      return resolvedTheme;
    }
  ...
  public static int getDefaultLightTheme(@NonNull Context context) {
    ...
    int resolvedTheme;
    resolvedTheme =
      getThemeByName("Theme.MaterialComponents.Light", resources, packageName);
    if (resolvedTheme != 0) {
      return resolvedTheme;
    }
    resolvedTheme =
