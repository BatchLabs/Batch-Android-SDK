...
public abstract class MessagePackHelper {
  ...
  public static void packObject(MessageBufferPacker packer, Object object)
    throws Exception {
    if (object == null) {
      packer.packNil();
  ...
  public static void packList(MessageBufferPacker packer, List<Object> list)
    throws Exception {
