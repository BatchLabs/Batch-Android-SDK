...
public class WebserviceSignature
{
    ...
    public static String encryptSignatureData(String data)
    {
        try {
            ...
            byte[] signature = Base64.encode(encryptHMAC(privateKey,
                    ByteArrayHelper.getUTF8Bytes(data)), Base64.DEFAULT);
    ...
    private static byte[] buildPrivateSignatureKey()
    {
        ...
        byte[] priv = CryptorFactory.getCryptorForType(CryptorFactory.CryptorType.EAS_BASE64).decryptToByte(
                privateKeyPart);
