...
public final class SystemParameterHelper
{
    ...
    public static Long getFirstInstallDate(Context applicationContext)
    {
        try {
            ...
            PackageInfo informations = packageManager.getPackageInfo(applicationContext.getPackageName(),
                    0);
    ...
    {
        try {
            PackageInfo infos = applicationContext.getPackageManager().getPackageInfo(getBundleName(
    ...
    public static Integer getAppVersionCode(Context applicationContext)
    {
        try {
            ...
            PackageInfo informations = packageManager.getPackageInfo(applicationContext.getApplicationContext().getPackageName(),
                    0);
    ...
    {
        if (!GenericHelper.checkPermission("android.permission.ACCESS_NETWORK_STATE",
                applicationContext))
        {
            return null;
        }
    ...
    public static String getSimOperatorName(Context applicationContext)
    {
         ...
         */
        if (!GenericHelper.checkPermission("android.permission.READ_PHONE_STATE",
                applicationContext))
        {
            return null;
        }
