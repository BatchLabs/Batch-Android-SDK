...
public class BatchPushPayload implements PushUserActionSource {
  ...
  BatchPushPayload(@NonNull Bundle extras) throws ParsingException {
    ...
    if (internalPushData == null) {
      throw new ParsingException(
        "Payload does not contain required Batch push data"
      );
    }
   ...
   */
  public static BatchPushPayload payloadFromBundle(@Nullable Bundle bundle)
    ...
    if (payload == null) {
      throw new ParsingException(
        "Given bundle does not contain push information in Batch.Push.PAYLOAD_KEY"
      );
    }
   ...
   * @throws ParsingException Thrown if the argument doesn't contain valid Batch Push data
   */
  public static BatchPushPayload payloadFromReceiverIntent(
   ...
   * @throws ParsingException Thrown if the argument doesn't contain valid Batch Push data
   */
  public static BatchPushPayload payloadFromReceiverExtras(
   ...
   * @throws ParsingException Thrown if the argument doesn't contain valid Batch Push data
   */
  public static BatchPushPayload payloadFromFirebaseMessage(
  ...
  public String getCustomLargeIconURL(Context context) {
    ...
    return ImageDownloadWebservice.buildImageURL(
      context,
      url,
      internalPushData.getCustomBigIconAvailableDensity()
    );
  }
