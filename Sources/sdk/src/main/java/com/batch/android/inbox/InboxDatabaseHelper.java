...
// -------------------------------------------->
    ...
    public void onCreate(SQLiteDatabase database)
    {
        database.execSQL("create table "
                ...
                + COLUMN_FETCHER_TYPE + " integer not null, "
                + COLUMN_FETCHER_IDENTIFIER + " text not null, "
                + "unique(" + COLUMN_FETCHER_TYPE + ", " + COLUMN_FETCHER_IDENTIFIER + "));");

        database.execSQL("create table "
                + TABLE_NOTIFICATIONS + "("
                + COLUMN_DB_ID + " integer primary key autoincrement, "
                + COLUMN_NOTIFICATION_ID + " text not null, "
                + COLUMN_SEND_ID + " text not null, "
        ...
        database.execSQL("create table "
                ...
                + COLUMN_DB_ID + " integer primary key autoincrement, "
                + COLUMN_FETCHER_ID + " integer not null, "
                + COLUMN_NOTIFICATION_ID + " text not null, "
                + COLUMN_INSTALL_ID + " text, "
                + COLUMN_CUSTOM_ID + " text, "
                + "unique(" + COLUMN_FETCHER_ID + ", " + COLUMN_NOTIFICATION_ID + "), "
                + "foreign key(" + COLUMN_FETCHER_ID + ") references " + TABLE_FETCHERS + "(" + COLUMN_DB_ID + "), "
                + "foreign key(" + COLUMN_NOTIFICATION_ID + ") references " + TABLE_NOTIFICATIONS + "(" + COLUMN_NOTIFICATION_ID + "));");
    }
