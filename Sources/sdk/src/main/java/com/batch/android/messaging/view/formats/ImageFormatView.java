...
public class ImageFormatView extends FrameLayout implements AsyncImageDownloadTask.ImageDownloadListener
{
     ...
     * @param context
     */
    public ImageFormatView(@NonNull Context context,
    ...
    private void addBackgroundView()
    {
        ...
        backgroundView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    {
        final ImageContainerView imageContainer = new ImageContainerView(context,
        ...
        if (imageView != null) {
            ...
            if (!message.isFullscreen) {
                ...
                if (d != null && imageContainerView != null) {
                    ...
                    imageContainerView.setTargetSize(new Size2D(
                            intrinsicWidth,
                            intrinsicHeight));
                }
            }
    ...
    public static class ImageContainerView extends FixedRatioFrameLayout implements DelegatedTouchEventViewGroup
    {
        ...
        public ImageContainerView(@NonNull Context context,
