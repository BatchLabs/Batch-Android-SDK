...
import com.batch.android.msgpack.core.buffer.ArrayBufferInput;
import com.batch.android.msgpack.core.buffer.ByteBufferInput;
import com.batch.android.msgpack.core.buffer.ChannelBufferInput;
import com.batch.android.msgpack.core.buffer.ChannelBufferOutput;
import com.batch.android.msgpack.core.buffer.InputStreamBufferInput;
import com.batch.android.msgpack.core.buffer.MessageBufferInput;
import com.batch.android.msgpack.core.buffer.MessageBufferOutput;
import com.batch.android.msgpack.core.buffer.OutputStreamBufferOutput;
 ...
 *   <tr><td>{@link com.batch.android.msgpack.core.buffer.MessageBufferInput}</td><td>{@link #newDefaultUnpacker(MessageBufferInput)}</td><td>{@link MessageUnpacker}</td></tr>
 * </table>
 *
 * <p>
 ...
 *   <tr><td>{@link com.batch.android.msgpack.core.buffer.MessageBufferOutput}</td><td>{@link #newDefaultPacker(MessageBufferOutput)}</td><td>{@link MessagePacker}</td></tr>
 * </table>
 */
public class MessagePack {
   ...
   * <p>
   * {@link com.batch.android.msgpack.core.buffer.MessageBufferOutput} is an interface that lets applications customize memory
   ...
   * <p>
   * {@link com.batch.android.msgpack.core.buffer.MessageBufferInput} is an interface that lets applications customize memory
   ...
   * @return A new MessageUnpacker instance
   */
  public static MessageUnpacker newDefaultUnpacker(
  ...
  public static class PackerConfig implements Cloneable {
    ...
    private PackerConfig(PackerConfig copy) {
      this.smallStringOptimizationThreshold =
        copy.smallStringOptimizationThreshold;
    ...
    public boolean equals(Object obj) {
      ...
      return (
        this.smallStringOptimizationThreshold ==
        o.smallStringOptimizationThreshold &&
     ...
     * {@link com.batch.android.msgpack.core.buffer.MessageBufferOutput#flush()} before writing more data (default: 8192).
     */
  ...
  public static class UnpackerConfig implements Cloneable {
    ...
    public int hashCode() {
      ...
      result =
        ...
        result +
        (
          actionOnMalformedString != null
            ? actionOnMalformedString.hashCode()
            : 0
        );
      result =
        31 *
        result +
        (
          actionOnUnmappableString != null
            ? actionOnUnmappableString.hashCode()
            : 0
        );
     ...
     * @return A new MessageUnpacker instance that will never throw IOException
     */
    public MessageUnpacker newUnpacker(
      byte[] contents,
      int offset,
      int length
    ) {
     ...
     */
    public UnpackerConfig withActionOnMalformedString(
     ...
     */
    public UnpackerConfig withActionOnUnmappableString(
      CodingErrorAction action
    ) {
      UnpackerConfig copy = clone();
