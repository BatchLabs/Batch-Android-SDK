...
public class ExtensionTypeHeader {
     ...
     * <pre>
     * {@code
     * import com.batch.android.msgpack.core.ExtensionTypeHeader;
     * import static com.batch.android.msgpack.core.ExtensionTypeHeader.checkedCastToByte;
     * ...
    ...
    public String toString() {
        return String.format(Locale.US, "ExtensionTypeHeader(type:%d, length:%,d)", type, length);
    }
}
