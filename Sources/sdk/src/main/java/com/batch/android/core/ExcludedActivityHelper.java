...
public class ExcludedActivityHelper {
   ...
   */
  private static final String EXCLUDED_ACTIVITY_META_DATA =
    "com.batch.android.EXCLUDE_FROM_LIFECYCLE";
   ...
   */
  public static boolean activityIsExcludedFromManifest(
    ...
    try {
      ...
      if (activityInfo.metaData != null) {
        isExcluded =
          activityInfo.metaData.getBoolean(EXCLUDED_ACTIVITY_META_DATA, false);
