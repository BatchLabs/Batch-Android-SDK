...
public interface ViewTracker {
   ...
   * @param campaignID
   */
  CountedViewEvent trackViewEvent(@NonNull String campaignID)
   ...
   */
  @NonNull
  CountedViewEvent getViewEvent(@NonNull String campaignId)
    throws ViewTrackerUnavailableException;
   ...
   */
  @NonNull
  Map<String, Integer> getViewCounts(@NonNull List<String> campaignsIds)
    throws ViewTrackerUnavailableException;
