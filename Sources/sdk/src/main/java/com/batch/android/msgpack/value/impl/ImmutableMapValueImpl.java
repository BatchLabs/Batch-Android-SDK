...
import com.batch.android.msgpack.value.MapValue;
 ...
 *
 * @see com.batch.android.msgpack.value.MapValue
 */
public class ImmutableMapValueImpl
  extends AbstractImmutableValue
  implements ImmutableMapValue {

  private static final ImmutableMapValueImpl EMPTY = new ImmutableMapValueImpl(
    new Value[0]
  );
  ...
  private static class EntrySetIterator
    ...
    public Map.Entry<Value, Value> next() {
      ...
      Map.Entry<Value, Value> pair = new AbstractMap.SimpleImmutableEntry<Value, Value>(
        key,
        value
      );
