...
public class LocalCampaignDebugFragment
  extends Fragment
  ...
  public static LocalCampaignDebugFragment newInstance(
    ...
    if (campaignToken != null) {
      for (LocalCampaign campaign : campaignManager.getCampaignList()) {
        if (
          ...
          campaign.publicToken.equals(campaignToken)
        ) {
          return campaign;
        }
      }
  ...
  private String formatDate(BatchDate date) {
    DateFormat df = new SimpleDateFormat(
      getString(R.string.com_batchsdk_debug_date_format),
      Locale.US
    );
      ...
      shareContent =
        shareContent.concat(
          String.format(
            "%s: %s\n",
            getString(
              R.string.com_batchsdk_local_campaign_debug_fragment_token
            ),
      ...
      shareContent =
        shareContent.concat(
          String.format(
            "%s: %s\n",
            getString(
              R.string.com_batchsdk_local_campaign_debug_fragment_start_date
            ),
      ...
      shareContent =
        shareContent.concat(
          String.format(
            "%s: %s\n",
            getString(
              R.string.com_batchsdk_local_campaign_debug_fragment_end_date
            ),
      ...
      shareContent =
        shareContent.concat(
          String.format(
            ...
            "%s: %d\n",
            getString(
              R.string.com_batchsdk_local_campaign_debug_fragment_capping
            ),
            campaign.capping
          )
        );
      ...
      shareContent =
        shareContent.concat(
          String.format(
            "%s: %s\n",
            getString(
              R.string.com_batchsdk_local_campaign_debug_fragment_trigger
            ),
            triggers.toString()
          )
        );
  ...
  private void displayCampaign(LocalCampaign campaign) {
    ...
    gracePeriod.setText(
      String.format(Locale.US, "%d", campaign.minimumDisplayInterval)
    );
    if (!campaign.triggers.isEmpty()) {
      StringBuilder triggers = new StringBuilder();
      for (LocalCampaign.Trigger trigger : campaign.triggers) {
  ...
  public View onCreateView(
    ...
    View view = inflater.inflate(
      R.layout.com_batchsdk_local_campaign_debug_fragment,
      container,
      false
    );
    token =
      view.findViewById(R.id.com_batchsdk_local_campaign_debug_fragment_token);
    startDate =
      view.findViewById(
        R.id.com_batchsdk_local_campaign_debug_fragment_start_date
      );
    endDate =
      view.findViewById(
        R.id.com_batchsdk_local_campaign_debug_fragment_end_date
      );
    capping =
      view.findViewById(
        R.id.com_batchsdk_local_campaign_debug_fragment_capping
      );
    gracePeriod =
      view.findViewById(R.id.com_batchsdk_local_campaign_debug_fragment_period);
    trigger =
      view.findViewById(
        R.id.com_batchsdk_local_campaign_debug_fragment_trigger
      );
    View shareButton = view.findViewById(
      R.id.com_batchsdk_identifier_debug_fragment_share_button
    );
  ...
  public void onClick(View v) {
    ...
    if (campaign != null) {
      ...
      sharingIntent.putExtra(
        ...
        getString(R.string.com_batchsdk_debug_view_title)
      );
      sharingIntent.putExtra(Intent.EXTRA_TEXT, shareContent);
      startActivity(
        Intent.createChooser(
          sharingIntent,
          getString(R.string.com_batchsdk_debug_view_share)
        )
      );
    }
  }
