...
{
    private final static String CAMPAIGN_TOKEN_KEY = "campaign_token";
    ...
    public static LocalCampaignDebugFragment newInstance(String campaignToken,
    ...
    private @Nullable
    LocalCampaign getCurrentCampaign()
    {
    ...
    {
        DateFormat df = new SimpleDateFormat(getString(R.string.com_batchsdk_debug_date_format),
                Locale.US);
    ...
    private void displayCampaign(LocalCampaign campaign)
    {
        ...
        gracePeriod.setText(String.format(Locale.US, "%d",
                campaign.minimumDisplayInterval));
        if (!campaign.triggers.isEmpty()) {
            StringBuilder triggers = new StringBuilder();
            for (LocalCampaign.Trigger trigger : campaign.triggers) {
    ...
    {
        View view = inflater.inflate(R.layout.com_batchsdk_local_campaign_debug_fragment,
                container, false);
