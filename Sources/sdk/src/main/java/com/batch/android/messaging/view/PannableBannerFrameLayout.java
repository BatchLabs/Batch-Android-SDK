 ...
 */
public class PannableBannerFrameLayout
  extends FrameLayout
  ...
  public PannableBannerFrameLayout(
    Context context,
      ...
      case MotionEvent.ACTION_UP:
        {
          ...
          if (
            translationY > (getHeight() * PAN_HEIGHT_DISMISS_RATIO_THRESHOLD)
          ) {
            dismiss();
          } else {
  ...
  private void cancelCancellationAnimation() {
    if (cancellationAnimation instanceof ValueAnimator) {
      ...
      supportsAndroidXAnimation &&
      cancellationAnimation instanceof DynamicAnimation
    ) {
