...
// ----------------------------------------->
    ...
    protected TrackerWebservice(Context context,
                                TrackerWebserviceListener listener,
                                List<Event> events,
                                boolean canBypassOptOut) throws MalformedURLException
    {
    ...
    public void run()
    {
        try {
            ...
            try {
                ...
                Logger.internal(TAG, "Error on TrackerWebservice : " + error.getReason().toString(),
                        error.getCause());
