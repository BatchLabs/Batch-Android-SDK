...
public final class Batch
{
     ...
     * Default placement
     */
    public final static String DEFAULT_PLACEMENT = "DEFAULT";
     ...
     */
    public final static String NOTIFICATION_TAG = "batch";
     ...
     */
    public final static String BROADCAST_PERMISSION_SUFFIX = ".batch.permission.INTERNAL_BROADCAST";
     ...
     */
    public final static String ACTION_REGISTRATION_IDENTIFIER_OBTAINED = "com.batch.android.intent.action.push.REGISTRATION_IDENTIFIER_OBTAINED";

    /**
     * Extra containing the Registration Identifier for a {@link #ACTION_REGISTRATION_IDENTIFIER_OBTAINED}
     * broadcast
     */
    public final static String EXTRA_REGISTRATION_IDENTIFIER = "registration_id";

    /**
     * Extra containing the Registration Provider name for a {@link #ACTION_REGISTRATION_IDENTIFIER_OBTAINED}
     * broadcast
     */
    public final static String EXTRA_REGISTRATION_PROVIDER_NAME = "provider_name";

    /**
     * Extra containing the Sender ID (if any) for a {@link #ACTION_REGISTRATION_IDENTIFIER_OBTAINED}
     * broadcast
     */
    public final static String EXTRA_REGISTRATION_SENDER_ID = "sender_id";
...
// ---------------------------------------------------->
    ...
    public static BatchUserProfile getUserProfile()
    {
        ...
        Logger.warning(UserModule.TAG,
                "Call to getUserProfile() made before onStart or after onStop. Returns null");
    ...
    {
        RuntimeManagerProvider.get().changeState(state -> {
            if (state != State.OFF) {
                Logger.error(
                        "You cannot update Batch's Configuration after Batch.onStart() has been called.");
                return null;
            }
     ...
     */
    public static void optOut(@NonNull Context context,
                              @Nullable BatchOptOutResultListener listener)
    {
    ...
    private static void _optOut(final @NonNull Context context,
                                boolean wipeData,
                                @Nullable final BatchOptOutResultListener listener)
    {
        ...
        OptOutModuleProvider.get().optOut(context, advertisingID, wipeData, listener)
                .then(value -> {
...
// ---------------------------------------------------->
    ...
    public final static class Inbox
    {
        ...
        public static BatchInboxFetcher getFetcher(@NonNull Context context)
        {
            ...
            return new BatchInboxFetcher(InboxFetcherInternalProvider.get(
                    context,
                    installID));
        }
        ...
        @Deprecated
        @NonNull
        public static BatchInboxFetcher getFetcher(@NonNull String userIdentifier,
                                                   @NonNull String authenticationKey)
        {
            return new BatchInboxFetcher(InboxFetcherInternalProvider.get(
                    null,
...
// ---------------------------------------------------->
    ...
    public final static class Push
    {
         ...
         * @param openIntent       the intent of the notification the will be triggered when the user clicks on it
         */
        public static void appendBatchData(@NonNull Bundle pushIntentExtras,
                                                      ...
                                                      @NonNull Bundle pushIntentExtras)
        {
            ...
            return PushModuleProvider.get().makePendingIntent(context,
                    intent,
                    pushIntentExtras);
        }
                                                                 ...
                                                                 @NonNull Bundle pushIntentExtras)
        {
            ...
            return PushModuleProvider.get().makePendingIntentForDeeplink(context,
                    deeplink,
                    pushIntentExtras);
        }
        ...
        public static void displayNotification(@NonNull Context context,
                                               ...
                                               boolean bypassManualMode)
        {
            PushModuleProvider.get().displayNotification(context,
                    intent,
                    interceptor,
                    bypassManualMode);
        }
    ...
    public final static class User
    {
         ...
         */
        public static void fetchAttributes(@NonNull final Context context,
         ...
         * @param listener Pass a listener to be notified of the fetch result.
         */
        public static void fetchTagCollections(@NonNull final Context context,
    ...
    public final static class Messaging
    {
        ...
        public interface LifecycleListener
        {
             ...
             */
            default void onBatchMessageActionTriggered(@Nullable String messageIdentifier,
                                                       int index,
             ...
             *                          DO NOT run the action yourself: the SDK will automatically do it.
             */
            default void onBatchMessageWebViewActionTriggered(@Nullable String messageIdentifier,
         ...
         */
        public static void setTypefaceOverride(@Nullable Typeface normalTypeface,
                                               @Nullable Typeface boldTypeface)
        {
            MessagingModuleProvider.get().setTypefaceOverride(normalTypeface,
                    boldTypeface);
        }
         ...
         */
        @NonNull
        public static DialogFragment loadFragment(@NonNull Context context,
                                                  @NonNull BatchMessage message) throws BatchMessagingException
        {
            ...
            return MessagingModuleProvider.get().loadFragment(context,
                    message,
                    message.getJSON());
        }
         ...
         */
        @NonNull
        public static BatchBannerView loadBanner(@NonNull Context context,
                                                 @NonNull BatchMessage message) throws BatchMessagingException
        {
            return MessagingModuleProvider.get().loadBanner(context,
                    message,
                    message.getJSON());
        }
    ...
    public final static class Actions
    {
         ...
         */
        public static boolean performAction(@NonNull Context context,
                                            @NonNull String actionIdentifier,
                                            @Nullable JSONObject arguments)
        {
            return ActionModuleProvider.get().performUserAction(context,
                    actionIdentifier,
                    arguments);
        }
     ...
     */
    private static void doBatchStart(final Context context,
                                     final boolean bumpRetainCount,
                                     final boolean userActivity)
    {
        ...
        boolean hasStarted = RuntimeManagerProvider.get().changeState(state -> {
            if (config == null) {
                Logger.error(
                ...
                try {
                    if (state != State.OFF && runtimeManager.getActivity() != null) {
                        if (activity.getWindow().isFloating() || activity instanceof MessagingActivity) {
                            ...
                            shouldRetainActivityInstance = !a.getBoolean(0,
                                    false); // <=> !isTranslucent. Condition is inverted since a translucent activity should NOT be retained
                            a.recycle();
                        }
                    }
                } catch (Exception e) {
            ...
            if (state == State.OFF) {
                 ...
                 */
                if (!GenericHelper.checkPermission("android.permission.INTERNET",
                ...
                if (Batch.user == null) {
                    Batch.user = new com.batch.android.User(
                            runtimeManager.getContext());
                }
                ...
                if (Batch.receiver == null) {
                    ...
                    LocalBroadcastManagerProvider.get(
                            runtimeManager.getContext()).registerReceiver(
                            receiver,
                            filter);
                }
         ...
         */
        if (hasStarted) {
            runtimeManager.runIf(State.READY, state -> {
                /*
                 * Call start webservice
                 */
                WebserviceLauncher.launchStartWebservice(runtimeManager,
                        fromPush.get(),
                        pushId.toString(),
                        userActivity);
            });
            ...
            if (apiKey != null && apiKey.toLowerCase(Locale.US).startsWith("dev")) {
                Logger.warning("Batch (" + Parameters.SDK_VERSION + ") is running in dev mode (your API key is a dev one)");
            }
     ...
     */
    private static void onStop(final Context _context,
                               final boolean fromService,
                               final boolean force)
    {
        /*
        ...
        boolean hasChanged = RuntimeManagerProvider.get().changeStateIf(State.READY,
                state -> {
                     ...
                     */
                    if (RuntimeManagerProvider.get().getActivity() != null ||
                            RuntimeManagerProvider.get().isRetainedByService())
                    {
                        Logger.internal(
                                "onStop called, but Batch is retained by a Service or Activity");
                        return null;
                    }
        ...
        if (hasChanged) {
            ...
            if (!TaskExecutorProvider.get(
                    RuntimeManagerProvider.get().getContext()).isBusy())
            {
    ...
    private static void onWebserviceExecutorWorkFinished()
    {
        ...
        RuntimeManagerProvider.get().runIf(State.FINISHING,
                state -> shouldStop.set(true));
    ...
    private static void doStop()
    {
         ...
         */
        boolean hasChanged = RuntimeManagerProvider.get().changeStateIf(State.FINISHING,
                state -> {
                    Logger.internal(
...
// ----------------------------------------------->
    ...
    private static void updateVersionManagement()
    {
        try {
            ...
            String savedVersion = ParametersProvider.get(
                    RuntimeManagerProvider.get().getContext()).get(
                    ParameterKeys.LIB_CURRENTVERSION_KEY);
            if (savedVersion == null) // First launch case
            {
                ParametersProvider.get(
                        RuntimeManagerProvider.get().getContext()).set(
                        ParameterKeys.LIB_CURRENTVERSION_KEY,
                        currentVersion,
                        true);
            } else if (!savedVersion.equals(currentVersion)) // new version
            {
                ...
                ParametersProvider.get(
                        RuntimeManagerProvider.get().getContext()).set(
                        ParameterKeys.LIB_PREVIOUSVERSION_KEY,
                        savedVersion,
                        true);
            }
        } catch (Exception e) {
    ...
    private static void checkForNotificationAuthorizationChange(@NonNull Context context)
    {
        ...
        if (lastNotificationAuthorizationStatus != hasNotificationAuthorization) {
            lastNotificationAuthorizationStatus = hasNotificationAuthorization;
            Logger.internal("Notification Authorization changed (is now " +
                    ( hasNotificationAuthorization ? "true" : "false" ) + ")");
            ...
            boolean sdkReady = runtimeManager.runIfReady(() -> {
                ...
                Registration registration = PushModuleProvider.get().getRegistration(
                        context);
            ...
            if (!sdkReady) {
                Logger.internal(
                        "Notif. Authorization changed but SDK isn't ready. Not sending update to the server.");
            }
        }
    }
