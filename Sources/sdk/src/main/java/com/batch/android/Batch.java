...
public final class Batch {
   ...
   */
  public static final String BROADCAST_PERMISSION_SUFFIX =
    ".batch.permission.INTERNAL_BROADCAST";
  ...
  public static LoggerLevel getLoggerLevel() {
    final AtomicReference<LoggerLevel> levelToUse = new AtomicReference<>(
      LoggerLevel.ERROR
    );
    RuntimeManagerProvider
      .get()
   ...
   */
  public static void copyBatchExtras(
    @Nullable Intent from,
    @Nullable Intent to
  ) {
   ...
   */
  public static void optOutAndWipeData(
    @NonNull Context context,
    @Nullable BatchOptOutResultListener listener
  ) {
  ...
  private static void _optOut(
    ...
    OptOutModuleProvider
      ...
      .then(value -> {
        ...
        Batch.onStop(
          a != null ? a : context.getApplicationContext(),
          false,
          true
        );
      })
  ...
  public static final class Inbox {
    ...
    public static BatchInboxFetcher getFetcher(@NonNull Context context) {
      ...
      return new BatchInboxFetcher(
        InboxFetcherInternalProvider.get(context, installID)
      );
    }
    ...
    public static BatchInboxFetcher getFetcher(
      ...
      return new BatchInboxFetcher(
        InboxFetcherInternalProvider.get(
          context,
          userIdentifier,
          authenticationKey
        )
  ...
  public static final class Push {
     ...
     */
    public static EnumSet<PushNotificationType> getNotificationsType(
      Context context
    ) {
     ...
     */
    public static void setNotificationsType(
      EnumSet<PushNotificationType> types
    ) {
     ...
     * @param openIntent       the intent of the notification the will be triggered when the user clicks on it
     */
    public static void appendBatchData(
    ...
    public static PendingIntent makePendingIntent(
      ...
      return PushModuleProvider
        .get()
        .makePendingIntent(context, intent, pushIntentExtras);
    }
    ...
    public static PendingIntent makePendingIntentForDeeplink(
      ...
      return PushModuleProvider
        .get()
        .makePendingIntentForDeeplink(context, deeplink, pushIntentExtras);
    }
    ...
    public static PendingIntent makePendingIntentForDeeplink(
      ...
      return PushModuleProvider
        .get()
        .makePendingIntentForDeeplink(context, deeplink, remoteMessage);
    }
     ...
     * @return true if the push will not be processed by Batch and should be handled, false otherwise
     */
    public static boolean shouldDisplayPush(
      Context context,
    ...
    public static void displayNotification(Context context, Intent intent) {
      PushModuleProvider
        .get()
        .displayNotification(context, intent, null, false);
    }
    ...
    public static void displayNotification(
      ...
      PushModuleProvider
        .get()
        .displayNotification(context, intent, null, bypassManualMode);
    }
    ...
    public static void displayNotification(
      ...
      PushModuleProvider
        .get()
        .displayNotification(context, intent, interceptor, false);
    }
    ...
    public static void displayNotification(
      ...
      PushModuleProvider
        .get()
        .displayNotification(context, intent, interceptor, bypassManualMode);
    }
    ...
    public static void displayNotification(
      ...
      PushModuleProvider
        .get()
        .displayNotification(context, remoteMessage, interceptor);
    }
     ...
     */
    public static void setNotificationInterceptor(
      @Nullable BatchNotificationInterceptor interceptor
    ) {
  ...
  public static final class EventDispatcher {
    ...
    public static boolean removeDispatcher(BatchEventDispatcher dispatcher) {
      return EventDispatcherModuleProvider
        .get()
    ...
    public enum Type {
      ...
      public boolean isNotificationEvent() {
        return (
          this == NOTIFICATION_OPEN ||
          this == NOTIFICATION_DISPLAY ||
          this == NOTIFICATION_DISMISS
        );
      }
  ...
  public static final class Messaging {
    ...
    public interface LifecycleListener {
       ...
       * @param messageIdentifier Analytics message identifier string. Can be null.
       */
      default void onBatchMessageCancelledByUser(
        @Nullable String messageIdentifier
      ) {}
       ...
       * @param messageIdentifier Analytics message identifier string. Can be null.
       */
      default void onBatchMessageCancelledByAutoclose(
        @Nullable String messageIdentifier
      ) {}
       ...
       * @param messageIdentifier Analytics message identifier string. Can be null.
       */
      default void onBatchMessageCancelledByError(
        @Nullable String messageIdentifier
      ) {}
    }
    ...
    public static class DisplayHint {
      ...
      private DisplayHint(
        @NonNull View view,
        @NonNull DisplayHintStrategy strategy
      ) {
     ...
     */
    public static void setShowForegroundLandings(
      boolean showForegroundLandings
    ) {
      MessagingModuleProvider
        .get()
        .setShowForegroundLandings(showForegroundLandings);
    }
     ...
     */
    public static void setTypefaceOverride(
      @Nullable Typeface normalTypeface,
      @Nullable Typeface boldTypeface
    ) {
      MessagingModuleProvider
        .get()
        .setTypefaceOverride(normalTypeface, boldTypeface);
    }
     ...
     */
    public static void setLifecycleListener(
      @Nullable LifecycleListener listener
    ) {
     ...
     */
    @NonNull
    public static DialogFragment loadFragment(
      @NonNull Context context,
      @NonNull BatchMessage message
    ) throws BatchMessagingException {
      ...
      return MessagingModuleProvider
        .get()
        .loadFragment(context, message, message.getJSON());
    }
     ...
     */
    @NonNull
    public static BatchBannerView loadBanner(
      @NonNull Context context,
      @NonNull BatchMessage message
    ) throws BatchMessagingException {
      return MessagingModuleProvider
        .get()
        .loadBanner(context, message, message.getJSON());
    }
  ...
  public static final class Actions {
     ...
     */
    public static void addDrawableAlias(
    ...
    public static boolean performAction(
      ...
      return ActionModuleProvider
        .get()
        .performUserAction(context, actionIdentifier, arguments);
    }
     ...
     */
    public static void setDeeplinkInterceptor(
      @Nullable BatchDeeplinkInterceptor interceptor
    ) {
   ...
   */
  private static void doBatchStart(
    final Context context,
    ...
    boolean hasStarted = RuntimeManagerProvider
      ...
      .changeState(state -> {
        ...
        if (!userActivity || lastUserStart != null) { // Force a start if Batch was started but without user activity and is now started with userActivity
          ...
          // Except if the last user active start happened more than 23h ago (if one happened at all)
            ...
            if (lastUserStart != null) {
              ...
              if (
                lastUserStart.getTime() > new Date().getTime() - 82800 * 1000
              ) {
                shouldStart = false;
              }
            } else {
        ...
        if (context instanceof Activity) {
          ...
          try {
            if (state != State.OFF && runtimeManager.getActivity() != null) {
              if (
                activity.getWindow().isFloating() ||
                activity instanceof MessagingActivity
              ) {
          ...
          if (excludedActivityHelper.hasIntent()) {
            Logger.internal(
              "Adding intent from an activity with exclusion meta-data"
            );
            intentParsers.add(
              new IntentParser(excludedActivityHelper.popIntent())
            );
          }
          ...
          if (MessagingModuleProvider.get().isInAutomaticMode()) {
            if (intentParser.hasLanding()) {
              if (intentParser.isLandingAlreadyShown()) {
                Logger.internal(
                  "Trying to display an already shown landing message"
                );
              } else {
        ...
        if (state == State.OFF) {
          ...
          if (Batch.user == null) {
            Batch.user =
              new com.batch.android.User(runtimeManager.getContext());
          }
          ...
          OptOutModuleProvider
            .get()
            .trackOptinEventIfNeeded(context, advertisingID);
        }
        ...
        if (intentParser != null && fromPush.get()) {
          if (intentParser.isOpenAlreadyTracked()) {
            ...
            TrackerModuleProvider
              .get()
              .track(InternalEvents.OPEN_FROM_PUSH, params);
            ...
            try {
              ...
              EventDispatcher.Payload payload = new PushEventPayload(
                pushPayload,
                true
              );
              ...
              BatchPushPayload.ParsingException | IllegalArgumentException e
            ) {
    ...
    if (hasStarted) {
      ...
      if (apiKey != null && apiKey.toLowerCase(Locale.US).startsWith("dev")) {
        Logger.warning(
          ...
          ") is running in dev mode (your API key is a dev one)"
        );
      }
    ...
    boolean hasChanged = RuntimeManagerProvider
      ...
      .changeStateIf(
        ...
        state -> {
          ...
          final Activity currentActivity = RuntimeManagerProvider
            .get()
            .getActivity();
          ...
          if (activity != null) {
            if (
              ExcludedActivityHelper.activityIsExcludedFromManifest(activity)
            ) {
  ...
  private static void onWebserviceExecutorWorkFinished() {
    ...
    RuntimeManagerProvider
      .get()
      .runIf(State.FINISHING, state -> shouldStop.set(true));

    Logger.internal(
      "onWebserviceExecutorWorkFinished called, should stop " + shouldStop
    );
    ...
    try {
      ...
      if (currentVersion == null) {
        throw new NullPointerException(
          "Unable to retrieve current lib version"
        );
      }
  ...
  private static void checkForNotificationAuthorizationChange(
    @NonNull Context context
  ) {
    ...
    if (lastNotificationAuthorizationStatus != hasNotificationAuthorization) {
      lastNotificationAuthorizationStatus = hasNotificationAuthorization;
      Logger.internal(
        "Notification Authorization changed (is now " +
      ...
      boolean sdkReady = runtimeManager.runIfReady(() -> {
        ...
        Registration registration = PushModuleProvider
          .get()
