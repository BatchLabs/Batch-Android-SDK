...
public class GCMAdsIdentifierProvider implements AdsIdentifierProvider {
  ...
  public void checkAvailability()
    throws AdsIdentifierProviderAvailabilityException {
        ...
        new TaskRunnable() {
          ...
          public void run() {
            try {
              ...
              Method getLimitedMethod = infoClazz.getMethod(
               ...
               * Get values
               */
              String value = (String) getValueMethod.invoke(
                response,
                (Object[]) null
              );
              boolean limited = (Boolean) getLimitedMethod.invoke(
                response,
                (Object[]) null
              );
