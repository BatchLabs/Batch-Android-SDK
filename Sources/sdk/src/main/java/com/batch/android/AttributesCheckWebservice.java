...
// ------------------------------------------>
    ...
    protected AttributesCheckWebservice(Context context,
                                        long version,
                                        String transactionID,
                                        AttributesCheckWebserviceListener listener) throws MalformedURLException
    {
    ...
    public void run()
    {
        try {
            ...
            try {
                ...
                Logger.internal(TAG, error.getReason().toString(),
                        error.getCause());
             ...
             * Read resposne
             */
            AttributesCheckResponse checkResponse = getResponseFor(AttributesCheckResponse.class,
