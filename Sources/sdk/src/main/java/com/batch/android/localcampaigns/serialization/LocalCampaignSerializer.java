...
public class LocalCampaignSerializer {
  ...
  public JSONObject serialize(LocalCampaign campaign) throws JSONException {
    ...
    jsonCampaign.put(
      "minDisplayInterval",
      Math.max(campaign.minimumDisplayInterval, 0)
    );
   ...
   * @throws JSONException parsing exception
   */
  public JSONArray serializeList(List<LocalCampaign> campaigns)
   ...
   * @throws JSONException parsing exception
   */
  private JSONObject parseOutput(LocalCampaign.Output output)
    throws JSONException {
   ...
   * @throws JSONException parsing exception
   */
  private JSONArray parseTriggers(List<LocalCampaign.Trigger> triggers)
    throws JSONException {
   ...
   * @throws JSONException parsing exception
   */
  private JSONObject parseTrigger(LocalCampaign.Trigger trigger)
    throws JSONException {
