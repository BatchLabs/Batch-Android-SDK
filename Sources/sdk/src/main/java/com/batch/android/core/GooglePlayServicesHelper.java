...
// ------------------------------------------------>
    ...
    {
        Integer libVersion = getGooglePlayServicesLibVersion(context);
        if (libVersion == null || libVersion < PUSH_ID_VERSION || !ReflectionHelper.isGMSGoogleCloudMessagingPresent()) {
            return null;
        }
...
// ------------------------------------------------>
    ...
    {
        return e.getCause() != null && ( e.getCause() instanceof IOException ) && "INVALID_SENDER".equals(
