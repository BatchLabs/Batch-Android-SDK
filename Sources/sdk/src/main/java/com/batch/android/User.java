...
// ------------------------------------------->
    ...
    {
        if (language != null) {
            ParametersProvider.get(context).set(ParameterKeys.USER_PROFILE_LANGUAGE_KEY,
                    language,
                    true);
        } else {
            ParametersProvider.get(
                    context).remove(ParameterKeys.USER_PROFILE_LANGUAGE_KEY);
        }
    }
    ...
    public String getLanguage()
    {
        return ParametersProvider.get(
                context).get(ParameterKeys.USER_PROFILE_LANGUAGE_KEY);
    }
...
// ------------------------------------------->
    ...
    {
        if (region != null) {
            ParametersProvider.get(context).set(ParameterKeys.USER_PROFILE_REGION_KEY,
                    region,
                    true);
        } else {
            ParametersProvider.get(
                    context).remove(ParameterKeys.USER_PROFILE_REGION_KEY);
        }
    }
    ...
    {
        return ParametersProvider.get(
                context).get(ParameterKeys.USER_PROFILE_REGION_KEY);
    }
...
// ------------------------------------------->
    ...
    {
        if (customID != null) {
            ParametersProvider.get(context).set(ParameterKeys.CUSTOM_ID,
                    customID,
                    true);
        } else {
...
// ------------------------------------------->
    ...
    {
        String version = ParametersProvider.get(
                context).get(ParameterKeys.USER_DATA_VERSION);
        if (version == null) {
            return 1;
        }
    ...
    private synchronized long incrementVersion()
    {
        ...
        ParametersProvider.get(context).set(ParameterKeys.USER_DATA_VERSION,
