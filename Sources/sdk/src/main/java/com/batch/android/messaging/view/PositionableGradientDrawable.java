...
public class PositionableGradientDrawable extends Drawable {
  ...
  public void setGradientRadius(float gradientRadius) {
    mGradientState.setGradientRadius(
      gradientRadius,
  ...
  public void draw(Canvas canvas) {
    ...
    final ColorFilter colorFilter = mColorFilter != null
      ? mColorFilter
      : mTintFilter;
  ...
  private Path buildRing(GradientState st) {
    ...
    float sweep = st.mUseLevelForShape
      ? (360.0f * getLevel() / 10000.0f)
      : 360f;
    ...
    float thickness = st.mThickness != -1
      ? st.mThickness
      : bounds.width() / st.mThicknessRatio;
    // inner radius
  ...
  public int getOpacity() {
    return (
        mAlpha == 255 && mGradientState.mOpaqueOverBounds && isOpaqueForState()
      )
      ? PixelFormat.OPAQUE
    ...
    if (mGradientIsDirty) {
      ...
      if (gradientColors != null) {
        ...
        if (st.mGradient == LINEAR_GRADIENT) {
          ...
          mFillPaint.setShader(
            new SweepGradient(x0, y0, tempColors, tempPositions)
          );
        }
  ...
  public void getOutline(Outline outline) {
    ...
    outline.setAlpha(
      st.mOpaqueOverShape && isOpaqueForState() ? (mAlpha / 255.0f) : 0.0f
    );
    ...
    switch (st.mShape) {
      ...
      case LINE:
        ...
        final float halfStrokeWidth = mStrokePaint == null
          ? 0.0001f
          : mStrokePaint.getStrokeWidth() * 0.5f;
  ...
  static final class GradientState extends ConstantState {
    ...
    private void computeOpacity() {
      ...
      mOpaqueOverBounds =
        mShape == RECTANGLE && mRadius <= 0 && mRadiusArray == null;
    }
  ...
  private void updateLocalState(Resources res) {
    ...
    if (state.mSolidColors != null) {
      ...
      final int stateColor = state.mSolidColors.getColorForState(
        currentState,
        0
      );
