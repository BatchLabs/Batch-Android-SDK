...
public class UserDataDebugFragment extends Fragment
{
    ...
    private void loadAttributes()
    {
        if (attributeAdapter == null) {
            attributeAdapter = new ArrayAdapter<>(
                    getContext(),
        ...
        Batch.User.fetchAttributes(getContext(), new BatchAttributesFetchListener()
        {
            @Override
    ...
    private void loadCollections()
    {
        ...
        Batch.User.fetchTagCollections(getContext(), new BatchTagCollectionsFetchListener()
        {
            @Override
                             ...
                             @Nullable Bundle savedInstanceState)
    {
        ...
        View view = inflater.inflate(R.layout.com_batchsdk_user_data_debug_fragment, container,
                false);
