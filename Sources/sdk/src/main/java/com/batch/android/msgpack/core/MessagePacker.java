...
import static com.batch.android.msgpack.core.MessagePack.Code.ARRAY16;
import static com.batch.android.msgpack.core.MessagePack.Code.ARRAY32;
import static com.batch.android.msgpack.core.MessagePack.Code.BIN16;
import static com.batch.android.msgpack.core.MessagePack.Code.BIN32;
import static com.batch.android.msgpack.core.MessagePack.Code.BIN8;
import static com.batch.android.msgpack.core.MessagePack.Code.EXT16;
import static com.batch.android.msgpack.core.MessagePack.Code.EXT32;
import static com.batch.android.msgpack.core.MessagePack.Code.EXT8;
import static com.batch.android.msgpack.core.MessagePack.Code.FALSE;
import static com.batch.android.msgpack.core.MessagePack.Code.FIXARRAY_PREFIX;
import static com.batch.android.msgpack.core.MessagePack.Code.FIXEXT1;
import static com.batch.android.msgpack.core.MessagePack.Code.FIXEXT16;
import static com.batch.android.msgpack.core.MessagePack.Code.FIXEXT2;
import static com.batch.android.msgpack.core.MessagePack.Code.FIXEXT4;
import static com.batch.android.msgpack.core.MessagePack.Code.FIXEXT8;
import static com.batch.android.msgpack.core.MessagePack.Code.FIXMAP_PREFIX;
import static com.batch.android.msgpack.core.MessagePack.Code.FIXSTR_PREFIX;
import static com.batch.android.msgpack.core.MessagePack.Code.FLOAT32;
import static com.batch.android.msgpack.core.MessagePack.Code.FLOAT64;
import static com.batch.android.msgpack.core.MessagePack.Code.INT16;
import static com.batch.android.msgpack.core.MessagePack.Code.INT32;
import static com.batch.android.msgpack.core.MessagePack.Code.INT64;
import static com.batch.android.msgpack.core.MessagePack.Code.INT8;
import static com.batch.android.msgpack.core.MessagePack.Code.MAP16;
import static com.batch.android.msgpack.core.MessagePack.Code.MAP32;
import static com.batch.android.msgpack.core.MessagePack.Code.NIL;
import static com.batch.android.msgpack.core.MessagePack.Code.STR16;
import static com.batch.android.msgpack.core.MessagePack.Code.STR32;
import static com.batch.android.msgpack.core.MessagePack.Code.STR8;
import static com.batch.android.msgpack.core.MessagePack.Code.TRUE;
import static com.batch.android.msgpack.core.MessagePack.Code.UINT16;
import static com.batch.android.msgpack.core.MessagePack.Code.UINT32;
import static com.batch.android.msgpack.core.MessagePack.Code.UINT64;
import static com.batch.android.msgpack.core.MessagePack.Code.UINT8;
...
import com.batch.android.msgpack.core.buffer.MessageBufferOutput;
...
public class MessagePacker implements Closeable, Flushable {
  ...
  /**
   * Create an MessagePacker that outputs the packed data to the given {@link com.batch.android.msgpack.core.buffer.MessageBufferOutput}.
   ...
   *
   * @param out MessageBufferOutput. Use {@link com.batch.android.msgpack.core.buffer.OutputStreamBufferOutput}, {@link com.batch.android.msgpack.core.buffer.ChannelBufferOutput} or
   *            your own implementation of {@link com.batch.android.msgpack.core.buffer.MessageBufferOutput} interface.
   */
  protected MessagePacker(
    MessageBufferOutput out,
    MessagePack.PackerConfig config
  ) {
    this.out = checkNotNull(out, "MessageBufferOutput is null");
    this.smallStringOptimizationThreshold =
      config.getSmallStringOptimizationThreshold();
  ...
  public MessageBufferOutput reset(MessageBufferOutput out) throws IOException {
    ...
    MessageBufferOutput newOut = checkNotNull(
      out,
      "MessageBufferOutput is null"
    );
  ...
  private void prepareEncoder() {
    if (encoder == null) {
       ...
       *
       * com.batch.android.msgpack.core.MessageStringCodingException: java.nio.charset.MalformedInputException: Input length = 1
       *     at com.batch.android.msgpack.core.MessagePacker.encodeStringToBufferAt(MessagePacker.java:467) ~[msgpack-core-0.8.6.jar:na]
       *     at com.batch.android.msgpack.core.MessagePacker.packString(MessagePacker.java:535) ~[msgpack-core-0.8.6.jar:na]
       *
  ...
  public MessagePacker packString(String s) throws IOException {
    if (s.length() <= 0) {
      ...
      CORRUPTED_CHARSET_ENCODER || s.length() < smallStringOptimizationThreshold
    ) {
      ...
      if (written >= 0) {
        if (str8FormatSupport && written < (1 << 8)) {
          ...
          if (written >= (1 << 16)) {
            ...
            throw new IllegalArgumentException(
              "Unexpected UTF-8 encoder state"
            );
          }
  ...
  public MessagePacker writePayload(byte[] src, int off, int len)
    ...
    if (
      buffer == null ||
      buffer.size() - position < len ||
      len > bufferFlushThreshold
    ) {
