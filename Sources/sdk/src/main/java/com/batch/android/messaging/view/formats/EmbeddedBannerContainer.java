...
public class EmbeddedBannerContainer implements BannerView.OnActionListener, PannableBannerFrameLayout.OnDismissListener, ImageHelper.Cache
{
    ...
    @Provide
    public static EmbeddedBannerContainer provide(@NonNull View attachTo,
    ...
    private EmbeddedBannerContainer(@NonNull MessagingModule messagingModule,
                                    ...
                                    boolean embed)
    {
        ...
        ViewCompat.setAccessibilityLiveRegion(rootView,
                ViewCompat.ACCESSIBILITY_LIVE_REGION_POLITE);
        ViewCompat.setImportantForAccessibility(rootView,
        ...
        rootView.setDismissDirection(pinnedVerticalEdge == VerticalEdge.TOP ? PannableBannerFrameLayout.DismissDirection.TOP : PannableBannerFrameLayout.DismissDirection.BOTTOM);
        ...
        if (!( bannerLP instanceof FrameLayout.LayoutParams )) {
            bannerLP = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT,
    ...
    public void show()
    {
        ...
        LocalBroadcastManager.getInstance(context).registerReceiver(dismissReceiver,
                new IntentFilter(
                        ACTION_DISMISS_BANNER));
    ...
    public void onGlobalAction()
    {
        ...
        if (message.globalTapAction != null) {
            messagingModule.performAction(context,
                    payloadMessage,
                    message.globalTapAction);
        } else {
            Logger.internal(MessagingModule.TAG,
