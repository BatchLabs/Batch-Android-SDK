...
public class ModalTemplateFragment
  ...
  implements
    ...
    ModalContentPanGestureDetector.OnDismissListener {
  ...
  public static ModalTemplateFragment newInstance(
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    setStyle(
      STYLE_NO_FRAME,
      showStatusbar
        ? R.style.com_batchsdk_ModalDialogTheme
  ...
  private View getBannerView(Context context) {
    ...
    if (model.allowSwipeToDismiss) {
      ModalContentPanGestureDetector detector = new ModalContentPanGestureDetector(
        context,
        false
      );
