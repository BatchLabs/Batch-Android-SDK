...
public final class BatchNotificationChannelsManager {
  ...
  String getChannelId(@Nullable BatchPushPayload payload) {
    ...
    if (payload != null && channelIdInterceptor != null) {
      try {
        String interceptedChannelId = channelIdInterceptor.getChannelId(
          payload,
          channelId
        );
  ...
  void registerBatchChannelIfNeeded(Context c) {
    if (
      ...
      Logger.internal(
        PushModule.TAG,
        "Registering default Batch notification channel"
      );
      //try {
  ...
  public void setChannelName(
    ...
    setChannelNameProvider(
      new StringResChannelNameProvider(context, channelNameResourceId)
    );
  }
   ...
   */
  public void setChannelIdInterceptor(
    @Nullable NotificationChannelIdInterceptor interceptor
  ) {
   ...
   * @return Whether the system settings have been opened or not. Always false on API < 26
   */
  public static boolean openSystemChannelSettings(
    @NonNull Context context,
  ...
  public static final class StringResChannelNameProvider
    ...
    public StringResChannelNameProvider(
      @NonNull Context context,
      @StringRes int channelNameResourceId
    ) {
  ...
  public interface NotificationChannelIdInterceptor {
    ...
    @Nullable
    String getChannelId(
      @NonNull BatchPushPayload payload,
      String deductedChannelId
    );
  }
}
