...
public class APENFormat extends BaseFormat implements NotificationFormat {
  ...
  public RemoteViews generateCollapsedView(@NonNull String packageName) {
    final RemoteViews view = new RemoteViews(
      packageName,
      R.layout.com_batchsdk_notification_layout_apen_collapsed
    );
  ...
  public RemoteViews generateExpandedView(@NonNull String packageName) {
    final RemoteViews view = new RemoteViews(
      packageName,
      R.layout.com_batchsdk_notification_layout_apen_expanded
    );
    ...
    view.setViewVisibility(
      R.id.com_batchsdk_notification_icon_centercrop,
      View.GONE
    );
    view.setViewVisibility(
      R.id.com_batchsdk_notification_icon_fitcenter,
      View.GONE
    );
  ...
  public void applyExtraBuilderConfiguration(
