...
public class MainDebugFragment extends Fragment {
  ...
  public View onCreateView(
    ...
    View view = inflater.inflate(
      R.layout.com_batchsdk_main_debug_fragment,
      container,
      false
    );
    View identifier = view.findViewById(
      R.id.com_batchsdk_main_debug_fragment_identifier
    );
    identifier.setOnClickListener((View v) -> {
      listener.onMenuSelected(BatchDebugActivity.IDENTIFIER_DEBUG_FRAGMENT);
    });

    View userData = view.findViewById(
      R.id.com_batchsdk_main_debug_fragment_user_data
    );
    userData.setOnClickListener((View v) -> {
      listener.onMenuSelected(BatchDebugActivity.USER_DATA_DEBUG_FRAGMENT);
    });

    View localCampaign = view.findViewById(
      R.id.com_batchsdk_main_debug_fragment_local_campaign
    );
    localCampaign.setOnClickListener((View v) -> {
      listener.onMenuSelected(
        BatchDebugActivity.LOCAL_CAMPAIGNS_DEBUG_FRAGMENT
      );
    });
    return view;
  }
