...
public final class LocalCampaignTrackDbHelper extends SQLiteOpenHelper
{
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + LocalCampaignEntry.TABLE_NAME + " (" +
                    LocalCampaignEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                    LocalCampaignEntry.COLUMN_NAME_CAMPAIGN_ID + " TEXT," +
                    LocalCampaignEntry.COLUMN_NAME_CAMPAIGN_KIND + " INTEGER," +
                    LocalCampaignEntry.COLUMN_NAME_CAMPAIGN_COUNT + " INTEGER," +
                    LocalCampaignEntry.COLUMN_NAME_CAMPAIGN_LAST_OCCURRENCE + " INTEGER," +
                    "unique (" + LocalCampaignEntry.COLUMN_NAME_CAMPAIGN_ID + ", " + LocalCampaignEntry.COLUMN_NAME_CAMPAIGN_KIND + ") on conflict replace)";

    private static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + LocalCampaignEntry.TABLE_NAME;
