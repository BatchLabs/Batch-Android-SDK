...
public class BatchMessagingWebViewJavascriptBridge {
  ...
  public String postMessage(
    ...
    @Nullable String rawJsonArguments
  ) {
    ...
    try {
      ...
      Logger.internal(
        TAG,
        "Could not deserialize postMessage arguments. Got: '" +
        rawJsonArguments +
        "'.",
        e
      );
    ...
    try {
      ...
      Logger.error(
        "Messaging",
        "In-App Webview Javascript SDK error (" +
        method +
        "): " +
        e1.getMessage()
      );
  ...
  private String makeSuccessResult(
    @NonNull BridgeResultProvider resultProvider
  ...
  private BridgeResultProvider getMethodResultProvider(
  ...
  protected String getAdvertisingID() throws BridgeResultProviderException {
    if (isAdvertisingIDAllowedByConfig()) {
      ...
      throw new BridgeResultProviderException(
        "Advertising ID unavailable: Disabled by config"
      );
    }
  }
  ...
  private String getCustomPayload() {
    try {
      ...
      throw new BridgeResultProviderRuntimeException(
        -23,
   ...
   */
  private static class BridgeResultProviderRuntimeException
