...
public class BatchMessagingWebViewJavascriptBridge
{
    ...
    public BatchMessagingWebViewJavascriptBridge(@NonNull Context context,
    ...
    public String postMessage(@Nullable String method, @Nullable String rawJsonArguments)
    {
        ...
        try {
            ...
            Logger.internal(TAG,
                    "Could not deserialize postMessage arguments. Got: '" + rawJsonArguments + "'.",
                    e);
        ...
        try {
            ...
            Logger.error("Messaging",
                    "Unknown In-App Webview Javascript SDK method: '" + method + "'");
            ...
            Logger.error("Messaging",
                    "In-App Webview Javascript SDK error (" + method + "): " + e1.getMessage());
    ...
    private String makeSuccessResult(@NonNull BridgeResultProvider resultProvider) throws BridgeResultProviderException
    {
        try {
    ...
    private BridgeResultProvider getMethodResultProvider(@NonNull String method,
                                                         @NonNull JSONObject arguments) throws BridgeResultProviderException, UnknownMethodException
    {
    ...
    private String getCustomPayload()
    {
        try {
            ...
            throw new BridgeResultProviderRuntimeException(-23,
                    "Could not copy custom payload JSON",
                    e);
        }
    }
    ...
    private void performAction(@NonNull JSONObject arguments)
    {
        ...
        if (TextUtils.isEmpty(name)) {
            throw new BridgeResultProviderRuntimeException(-21,
                    "Cannot perform action: empty name");
        }
    ...
    private void openDeeplink(@NonNull JSONObject arguments)
    {
        ...
        if (TextUtils.isEmpty(url)) {
            throw new BridgeResultProviderRuntimeException(-21,
                    "Cannot perform action: empty URL");
        }
    ...
    private static class BridgeResultProviderRuntimeException extends RuntimeException
    {
        ...
        public BridgeResultProviderRuntimeException(int code,
