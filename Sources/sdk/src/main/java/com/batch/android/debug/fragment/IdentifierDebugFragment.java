...
public class IdentifierDebugFragment
  extends Fragment
  ...
  private String getShareString() {
    ...
    shareContent =
      shareContent.concat("Version: " + BuildConfig.SDK_VERSION + "\n");
    shareContent =
      shareContent.concat(
        String.format(
          "%s: %s\n",
      ...
      shareContent =
        shareContent.concat(
          String.format(
            "%s: %s\n",
            getString(
              R.string.com_batchsdk_identifier_debug_fragment_advertising_id
            ),
            advertisingID.get()
          )
        );
      ...
      shareContent =
        shareContent.concat(
          String.format(
            "%s: %s\n",
            getString(
              R.string.com_batchsdk_identifier_debug_fragment_push_token
            ),
            token
          )
        );
  ...
  public View onCreateView(
    ...
    View view = inflater.inflate(
      R.layout.com_batchsdk_identifier_debug_fragment,
      container,
      false
    );
    sdkVersion =
      view.findViewById(
        R.id.com_batchsdk_identifier_debug_fragment_sdk_version
      );
    installId =
      view.findViewById(R.id.com_batchsdk_identifier_debug_fragment_install_id);
    advertisingId =
      view.findViewById(
        R.id.com_batchsdk_identifier_debug_fragment_advertising_id
      );
    pushToken =
      view.findViewById(R.id.com_batchsdk_identifier_debug_fragment_push_token);
