...
public class BannerView extends RelativeLayout implements SeparatedFlexboxLayout.SeparatorStyleProvider, AsyncImageDownloadTask.ImageDownloadListener
{
                      ...
                      @Nullable ImageHelper.Cache imageCache)
    {
        ...
        ReflectionHelper.optOutOfDarkMode(this);
        ...
        setLayoutParams(StyleHelper.getFrameLayoutParams(this.context, new FrameLayout.LayoutParams(
        ...
        RelativeLayout.LayoutParams lp = StyleHelper.getRelativeLayoutParams(context,
    ...
    private SeparatedFlexboxLayout makeContentLayout(Map<String, String> contentStyleRules)
    {
        ...
        if (!TextUtils.isEmpty(message.titleText)) {
            ...
            final FlexboxLayout.LayoutParams titleLp = new FlexboxLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
            titleLp.flexGrow = 1;
        ...
        final TextView bodyTv = (TextView) inflater.inflate(R.layout.com_batchsdk_messaging_scrollabletextview,
                layout, false);
        ...
        final FlexboxLayout.LayoutParams bodyLp = new FlexboxLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        bodyLp.flexGrow = 1;
        bodyLp.flexShrink = 0;
        ...
        if (ctaLayout != null) {
            ...
            FlexboxLayout.LayoutParams ctaLP = new FlexboxLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private SeparatedFlexboxLayout makeCTALayout(Map<String, String> rules)
    {
        ...
        for (int i = 0; i < ctas.size(); i++) {
            ...
            final String btnDirectionalClass = "btn-" + ( message.ctaDirection == BannerMessage.CTADirection.HORIZONTAL ? "h" : "v" );

            final View view = getStyledFlexboxSubview(new Pair<>(ctaView,
                    new DOMNode("cta" + ( i + 1 ), "btn", btnDirectionalClass)));
            if (message.ctaDirection == BannerMessage.CTADirection.HORIZONTAL) {
    ...
    private void addImage()
    {
        if (message.imageURL != null) {
            ...
            PercentRelativeLayout.LayoutParams lp = StyleHelper.getRelativeLayoutParams(context,
                    new PercentRelativeLayout.LayoutParams(
                            ViewGroup.LayoutParams.WRAP_CONTENT,
                            ViewGroup.LayoutParams.WRAP_CONTENT),
                    rules,
    ...
    private void addCloseButton()
    {
        ...
        if (message.showCloseButton || ( !canAutoClose() && message.autoCloseDelay > 0 )) {
            ...
            closeButton.setLayoutParams(StyleHelper.getRelativeLayoutParams(context,
                    new PercentRelativeLayout.LayoutParams(
                            ViewGroup.LayoutParams.WRAP_CONTENT,
                            ViewGroup.LayoutParams.WRAP_CONTENT),
                    closeButtonRules,
    ...
    @Override
    public Map<String, String> getRulesForSeparator(SeparatedFlexboxLayout layout,
                                                    String separatorID)
    {
        return getRulesForView(new DOMNode(separatorID,
                layout.getSeparatorPrefix() + "-" + ( layout.isHorizontal() ? "h-sep" : "sep" )));
    }
    ...
    private void onGlobalTap()
    {
        if (message.globalTapDelay > 0 && mustWaitTapDelay()) {
            Logger.info(MessagingModule.TAG,
