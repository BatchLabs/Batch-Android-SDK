...
public class TextView extends android.widget.TextView implements Styleable
{
    ...
    protected static void applyStyleRules(android.widget.TextView targetTextView,
                                          Map<String, String> rules)
    {
        ...
        for (Map.Entry<String, String> rule : rules.entrySet()) {
            if ("color".equalsIgnoreCase(rule.getKey())) {
                ...
                if (fontSize != null) {
                    ...
                    targetTextView.setTextSize(isSizeSP ? TypedValue.COMPLEX_UNIT_SP : TypedValue.COMPLEX_UNIT_DIP,
                            fontSize);
                }
                ...
                if (balanced != null) {
                    ...
                    targetTextView.setBreakStrategy(balanced > 0 ? Layout.BREAK_STRATEGY_BALANCED : Layout.BREAK_STRATEGY_SIMPLE);
                }
            }
        }
        ...
        if (lineSpacingMultiply != 0 || lineSpacingAdd != 0) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                targetTextView.setLineSpacing(lineSpacingAdd != 0 ? lineSpacingAdd : targetTextView.getLineSpacingExtra(),
    ...
    public void makeScrollable()
    {
        ...
        {
            GestureDetector gesture = new GestureDetector(getContext(),
                    new GestureDetector.SimpleOnGestureListener()
                    {
                        ...
                        public boolean onFling(MotionEvent e1,
                                               ...
                                               float velocityY)
                        {
                            int maxScrollY = getLayout().getHeight() - getHeight() + getPaddingTop() + getPaddingBottom();
