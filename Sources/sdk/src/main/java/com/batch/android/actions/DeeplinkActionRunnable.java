...
public class DeeplinkActionRunnable implements UserActionRunnable {
  ...
  public static final String IDENTIFIER =
    ActionModule.RESERVED_ACTION_IDENTIFIER_PREFIX + "deeplink";
  ...
  public void performAction(
    ...
    if (context == null) {
      Logger.error(
        TAG,
        "Tried to perform a Deeplink action, but no context was available"
      );
      return;
    }
    ...
    try {
      if (!TextUtils.isEmpty(target)) {
        ...
        boolean useCustomTab =
          args.reallyOptBoolean(ARGUMENT_SHOW_LINK_INAPP, false) &&
          !(source instanceof BatchPushPayload);
