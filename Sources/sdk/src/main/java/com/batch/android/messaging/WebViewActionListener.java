...
public interface WebViewActionListener
{
    ...
    void onErrorAction(@NonNull BatchMessagingWebViewJavascriptBridge.DevelopmentErrorCause developmentCause,
                       @NonNull MessagingError messagingCause,
                       @Nullable String description);

    void onOpenDeeplinkAction(@NonNull String url,
                              @Nullable Boolean openInAppOverride,
                              @Nullable String analyticsID);

    void onPerformAction(@NonNull String action,
