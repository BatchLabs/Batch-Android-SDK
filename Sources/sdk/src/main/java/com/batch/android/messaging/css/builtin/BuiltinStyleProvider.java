...
public class BuiltinStyleProvider implements ImportFileProvider {
  ...
  private static Map<String, String[]> generateMetaStyles() {
    ...
    retVal.put(
      "generic1-h-cta",
      new String[] { "generic1_h-cta", "generic1_base" }
    );
    retVal.put(
      "generic1-v-cta",
      new String[] { "generic1_v-cta", "generic1_base" }
    );
    retVal.put(
      "image1-fullscreen",
      new String[] { "image1_fullscreen", "image1_base" }
    );
    retVal.put(
      "image1-detached",
      new String[] { "image1_detached", "image1_base" }
    );
    return retVal;
  }
}
