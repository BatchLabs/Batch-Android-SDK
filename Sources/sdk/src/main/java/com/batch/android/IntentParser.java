...
public final class IntentParser {
   ...
   */
  private static final String ALREADY_SHOWN_LANDING_KEY =
    "com.batch.messaging.push.shown";

  /**
   * Key used to remember if an intent open has been tracked already
   */
  private static final String ALREADY_TRACKED_OPEN_KEY =
    "com.batch.open.tracked";
  ...
  public void markOpenAsAlreadyTracked() {
    if (comesFromPush()) {
      ...
      Logger.internal(
        TAG,
        "Trying to consume an open that does not come from a push"
      );
    }
  }
   ...
   */
  public static void putPushExtrasToIntent(
    Bundle fullPayload,
