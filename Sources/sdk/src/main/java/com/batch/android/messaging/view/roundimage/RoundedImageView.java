...
public class RoundedImageView extends ImageView implements Styleable
{
    ...
    {
        cornerRadius = radius;
        setCornerRadius(roundedCorners[Corner.TOP_LEFT] ? radius : 0,
    ...
    public void applyStyleRules(Map<String, String> rules)
    {
        ...
        for (Map.Entry<String, String> rule : rules.entrySet()) {
            if ("border-radius".equalsIgnoreCase(rule.getKey())) {
                ...
                setCornerRadius(radius != null ? StyleHelper.dpToPixels(getResources(),
                        radius) : 0);
        ...
        setPadding(StyleHelper.dpToPixels(res, padding[0]),
