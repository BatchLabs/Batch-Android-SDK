...
public class PayloadParser
{
    ...
    public static Message parsePayload(JSONObject payload) throws PayloadParsingException
    {
        ...
        if (resultMessage instanceof AlertMessage) {
            try {
                ...
                throw new PayloadParsingException("Error while decoding the JSON payload (code 3)",
                        e);
            }
            ...
            try {
                ...
                throw new PayloadParsingException("Error while decoding the JSON payload (code 4)",
                        e);
            }
            ...
            try {
                ...
                throw new PayloadParsingException("Error while decoding the JSON payload (code 6)",
                        e);
            }
            ...
            try {
                ...
                throw new PayloadParsingException("Error while decoding the JSON payload (code 7)",
                        e);
            }
            ...
            try {
                ...
                throw new PayloadParsingException("Error while decoding the JSON payload (code 8)",
                        e);
            }
            ...
            try {
                ...
                throw new PayloadParsingException("Error while decoding the JSON payload (code 9)",
                        e);
            }
        }
    ...
    public static Message parseBasePayload(JSONObject payload) throws PayloadParsingException, JSONException
    {
        ...
        if (minimumAndroidAPIVersion != null &&
    ...
    private static AlertMessage parseAlertPayload(JSONObject payload,
                                                  AlertMessage message) throws PayloadParsingException, JSONException
    {
    ...
    private static UniversalMessage parseUniversalPayload(JSONObject payload,
                                                          UniversalMessage message) throws PayloadParsingException, JSONException
    {
    ...
    private static BannerMessage parseBannerPayload(JSONObject payload,
                                                    BannerMessage message) throws PayloadParsingException, JSONException
    {
        parseBaseBannerPayload(payload, message);
        return message;
    }

    private static ModalMessage parseModalPayload(JSONObject payload,
                                                  ModalMessage message) throws PayloadParsingException, JSONException
    {
        parseBaseBannerPayload(payload, message);
        return message;
    }

    private static void parseBaseBannerPayload(JSONObject payload,
                                               BaseBannerMessage message) throws PayloadParsingException, JSONException
    {
        message.css = payload.getString("style");
        message.titleText = payload.reallyOptString("title", null);
    ...
    private static ImageMessage parseImagePayload(JSONObject payload,
                                                  ImageMessage message) throws PayloadParsingException, JSONException
    {
    ...
    private static WebViewMessage parseWebViewPayload(JSONObject payload,
                                                      WebViewMessage message) throws PayloadParsingException, JSONException
    {
