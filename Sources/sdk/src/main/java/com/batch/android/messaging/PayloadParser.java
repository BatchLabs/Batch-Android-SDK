...
public class PayloadParser {
  ...
  public static Message parsePayload(JSONObject payload)
    ...
    try {
      ...
      throw new PayloadParsingException(
        "Error while decoding the JSON payload (code 2)",
        e
      );
    }
    ...
    if (resultMessage instanceof AlertMessage) {
      try {
        resultMessage =
          parseAlertPayload(payload, (AlertMessage) resultMessage);
      } catch (JSONException e) {
        throw new PayloadParsingException(
          "Error while decoding the JSON payload (code 3)",
          e
        );
      }
      ...
      try {
        resultMessage =
          parseUniversalPayload(payload, (UniversalMessage) resultMessage);
      } catch (JSONException e) {
        throw new PayloadParsingException(
          "Error while decoding the JSON payload (code 4)",
          e
        );
      }
      ...
      try {
        resultMessage =
          parseBannerPayload(payload, (BannerMessage) resultMessage);
      } catch (JSONException e) {
        throw new PayloadParsingException(
          "Error while decoding the JSON payload (code 6)",
          e
        );
      }
      ...
      try {
        resultMessage =
          parseModalPayload(payload, (ModalMessage) resultMessage);
      } catch (JSONException e) {
        throw new PayloadParsingException(
          "Error while decoding the JSON payload (code 7)",
          e
        );
      }
      ...
      try {
        resultMessage =
          parseImagePayload(payload, (ImageMessage) resultMessage);
      } catch (JSONException e) {
        throw new PayloadParsingException(
          "Error while decoding the JSON payload (code 8)",
          e
        );
      }
      ...
      try {
        resultMessage =
          parseWebViewPayload(payload, (WebViewMessage) resultMessage);
      } catch (JSONException e) {
        throw new PayloadParsingException(
          "Error while decoding the JSON payload (code 9)",
          e
        );
      }
    }
  ...
  public static Message parseBasePayload(JSONObject payload)
    ...
    Integer minimumMessagingAPIVersion = payload.reallyOptInteger(
      "minapi",
      null
    );
    if (
    ...
    Integer minimumAndroidAPIVersion = payload.reallyOptInteger(
      "min_android_sdk",
      null
    );
    if (
      ...
      Logger.error(
        MessagingModule.TAG,
        "This device is too old to display this message. Please update it."
      );
  ...
  private static AlertMessage parseAlertPayload(
    JSONObject payload,
    ...
    if (
      TextUtils.isEmpty(message.titleText) &&
      TextUtils.isEmpty(message.bodyText)
    ) {
      throw new PayloadParsingException(
        "Alert payload requires at least a title or a body"
      );
    }
  ...
  private static UniversalMessage parseUniversalPayload(
    JSONObject payload,
    ...
    message.attachCTAsBottom =
      payload.reallyOptBoolean("attach_cta_bottom", null);
    message.stackCTAsHorizontally =
      payload.reallyOptBoolean("stack_cta_h", null);
    message.stretchCTAsHorizontally =
      payload.reallyOptBoolean("stretch_cta_h", null);
    ...
    if (
      ...
      (message.heroSplitRatio <= 0 || message.heroSplitRatio >= 1)
    ) {
  ...
  private static BannerMessage parseBannerPayload(
    JSONObject payload,
  ...
  private static ModalMessage parseModalPayload(
    JSONObject payload,
  ...
  private static void parseBaseBannerPayload(
    JSONObject payload,
    BaseBannerMessage message
  ) throws PayloadParsingException, JSONException {
    message.css = payload.getString("style");
    message.titleText = payload.reallyOptString("title", null);
    message.globalTapDelay = payload.reallyOptInteger("global_tap_delay", 0);
    message.allowSwipeToDismiss =
      payload.reallyOptBoolean("swipe_dismiss", true);
    message.imageURL = payload.reallyOptString("image", null);
    message.imageDescription =
      payload.reallyOptString("image_description", null);
  ...
  private static ImageMessage parseImagePayload(
    JSONObject payload,
  ...
  private static WebViewMessage parseWebViewPayload(
    JSONObject payload,
    ...
    message.openDeeplinksInApp =
      payload.reallyOptBoolean("inAppDeeplinks", false);
  ...
  private static Action parseAction(JSONObject actionJSON)
    throws PayloadParsingException, JSONException {
