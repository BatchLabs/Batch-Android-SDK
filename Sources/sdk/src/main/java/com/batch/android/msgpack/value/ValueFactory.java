...
import com.batch.android.msgpack.value.impl.ImmutableArrayValueImpl;
import com.batch.android.msgpack.value.impl.ImmutableBigIntegerValueImpl;
import com.batch.android.msgpack.value.impl.ImmutableBinaryValueImpl;
import com.batch.android.msgpack.value.impl.ImmutableBooleanValueImpl;
import com.batch.android.msgpack.value.impl.ImmutableDoubleValueImpl;
import com.batch.android.msgpack.value.impl.ImmutableExtensionValueImpl;
import com.batch.android.msgpack.value.impl.ImmutableLongValueImpl;
import com.batch.android.msgpack.value.impl.ImmutableMapValueImpl;
import com.batch.android.msgpack.value.impl.ImmutableNilValueImpl;
import com.batch.android.msgpack.value.impl.ImmutableStringValueImpl;
...
public final class ValueFactory {
  ...
  public static ImmutableBinaryValue newBinary(
    byte[] b,
    int off,
    int len,
    boolean omitCopy
  ...
  public static ImmutableStringValue newString(
    byte[] b,
    int off,
    int len,
    boolean omitCopy
  ...
  public static <K extends Value, V extends Value> ImmutableMapValue newMap(
    Map<K, V> map
  ) {
  ...
  @SafeVarargs
  public static MapValue newMap(
    Map.Entry<? extends Value, ? extends Value>... pairs
  ) {
