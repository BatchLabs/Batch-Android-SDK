...
public class UniversalTemplateFragment extends BaseDialogFragment<UniversalMessage> implements UniversalRootView.OnActionListener, AsyncImageDownloadTask.ImageDownloadListener, MediaPlayer.OnPreparedListener, TextureView.SurfaceTextureListener
{
    ...
    public static UniversalTemplateFragment newInstance(BatchMessage payloadMessage,
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        setStyle(STYLE_NO_FRAME,
                showStatusbar ? R.style.com_batchsdk_UniversalDialogTheme
                             ...
                             @Nullable Bundle savedInstanceState)
    {
        ...
        if (messageModel.videoURL != null) {
            ...
            if (mediaPlayer == null) {
                ...
                try {
                    ...
                    Logger.internal(TAG,
                            "Error while creating the MediaPlayer for URL " + messageModel.videoURL,
                            e);
                }
        ...
        if (messageModel.videoURL == null && messageModel.heroImageURL != null && heroDownloadTask == null) {
            ...
            if (cachedResult != null) {
                ...
                heroDownloadTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,
    ...
    private View getUniversalView(@NonNull Context context)
    {
        ...
        view = new UniversalRootView(themedContext,
                getMessageModel(),
                getStyle(),
                heroDownloadResult,
