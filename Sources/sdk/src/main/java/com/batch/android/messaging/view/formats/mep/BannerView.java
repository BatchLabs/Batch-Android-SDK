...
import com.batch.android.messaging.view.styled.mep.SeparatedFlexboxLayout;
 ...
 * Meant to be used in {@link MEPBannerContainer}.
...
public class BannerView
    ...
    private EmbeddedBannerContainer.VerticalEdge pinnedVerticalEdge;
    ...
    private SeparatedFlexboxLayout makeContentLayout(Map<String, String> contentStyleRules) {
        ...
        EmbeddedBannerContainer.VerticalEdge contentPinnedEdge = getPinnedVerticalEdge(contentStyleRules);
    ...
    private EmbeddedBannerContainer.VerticalEdge getPinnedVerticalEdge(Map<String, String> rules) {
        for (Map.Entry<String, String> rule : rules.entrySet()) {
            if ("vertical-align".equalsIgnoreCase(rule.getKey())) {
                final String value = rule.getValue();
                if ("top".equalsIgnoreCase(value)) {
                    return EmbeddedBannerContainer.VerticalEdge.TOP;
                } else if ("bottom".equalsIgnoreCase(value)) {
                    return EmbeddedBannerContainer.VerticalEdge.BOTTOM;
                }
            }
        }
    ...
    @NonNull
    public EmbeddedBannerContainer.VerticalEdge getPinnedVerticalEdge() {
        return pinnedVerticalEdge != null ? pinnedVerticalEdge : EmbeddedBannerContainer.VerticalEdge.BOTTOM;
    }
