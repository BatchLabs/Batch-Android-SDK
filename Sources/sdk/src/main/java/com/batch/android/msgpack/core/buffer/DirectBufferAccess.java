    ...
    try {
      ...
      try {
        ...
        directByteBufferConstructor =
          directByteBufferClass.getDeclaredConstructor(
            long.class,
            int.class,
            Object.class
          );
        ...
        try {
          ...
          try {
            ...
            mbWrap =
              aClass.getDeclaredMethod("wrapFromJni", int.class, long.class);
      ...
      if (byteBufferConstructor == null) {
        throw new RuntimeException(
          "Constructor of DirectByteBuffer is not found"
        );
      }
