...
public class SeparatedFlexboxLayout
  extends FlexboxLayout
  implements Styleable, DelegatedTouchEventViewGroup {
  ...
  public SeparatedFlexboxLayout(
    Context context,
    String separatorPrefix,
    SeparatorStyleProvider styleProvider
  ) {
    super(context);
    ...
    if (TextUtils.isEmpty(separatorPrefix)) {
      throw new IllegalArgumentException(
        "separatorPrefix cannot be null or empty"
      );
    }
    ...
    separator.setLayoutParams(
      StyleHelper.getFlexLayoutParams(
        ...
        new FlexboxLayout.LayoutParams(
          StyleHelper.dpToPixels(getResources(), 10f),
          0
        ),
        rules
      )
  ...
  public interface SeparatorStyleProvider {
    Map<String, String> getRulesForSeparator(
