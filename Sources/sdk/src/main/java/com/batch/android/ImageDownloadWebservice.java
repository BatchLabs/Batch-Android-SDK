...
public class ImageDownloadWebservice extends Webservice
{
    ...
    protected ImageDownloadWebservice(Context context,
                                      String imageURL,
                                      List<Double> availableDensities) throws MalformedURLException
    {
...
// ---------------------------------------------->
     ...
     * @return
     */
    public static String buildImageURL(Context context,
                                       String imageURL,
                                       List<Double> availableDensities)
    {
